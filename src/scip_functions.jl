...
SCIPchgCharParam(scip::SCIP_t, param::SCIP_PARAM_t, value) = @scip_ccall_check("SCIPchgCharParam", (Ptr{SCIP}, Ptr{SCIP_PARAM}, Char), pointer(scip), pointer(param), value)
...
SCIPpropagateProbing(scip::SCIP_t, maxproprounds, cutoff::SCIP_Bool_t, ndomredsfound) = @scip_ccall_check("SCIPpropagateProbing", (Ptr{SCIP}, Int, Ptr{SCIP_Bool}, Ptr{Int64}), pointer(scip), maxproprounds, pointer(cutoff), ndomredsfound)
