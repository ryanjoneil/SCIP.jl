...
#SCIPexprgraphFindConstNode(exprgraph::SCIP_EXPRGRAPH_t, constant::SCIP_Real, constnode::SCIP_EXPRGRAPHNODE_t) = @scip_ccall("SCIPexprgraphFindConstNode", SCIP_Bool, (Ptr{SCIP_EXPRGRAPH}, SCIP_Real, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}), pointer(exprgraph), constant, pointer(pointer(constnode)))
...
# SCIP function wrappers: unchecked functions
#SCIPexprtreeSetVars(tree::SCIP_EXPRTREE_t, nvars, vars::SCIP_VAR_t) = @scip_ccall_check("SCIPexprtreeSetVars", (Ptr{SCIP_EXPRTREE}, Int, Ptr{Ptr{SCIP_VAR}}), pointer(tree), nvars, pointer(pointer(vars)))
#SCIPexprtreeAddVars(tree::SCIP_EXPRTREE_t, nvars, vars::SCIP_VAR_t) = @scip_ccall_check("SCIPexprtreeAddVars", (Ptr{SCIP_EXPRTREE}, Int, Ptr{Ptr{SCIP_VAR}}), pointer(tree), nvars, pointer(pointer(vars)))
...
#SCIPexprtreeFree(tree::SCIP_EXPRTREE_t) = @scip_ccall_check("SCIPexprtreeFree", (Ptr{Ptr{SCIP_EXPRTREE}},), pointer(pointer(tree)))
...
#SCIPexprtreeSubstituteVars(tree::SCIP_EXPRTREE_t, substexprs::SCIP_EXPR_t) = @scip_ccall_check("SCIPexprtreeSubstituteVars", (Ptr{SCIP_EXPRTREE}, Ptr{Ptr{SCIP_EXPR}}), pointer(tree), pointer(pointer(substexprs)))
#SCIPexprgraphMoveNodeParents(exprgraph::SCIP_EXPRGRAPH_t, srcnode::SCIP_EXPRGRAPHNODE_t, targetnode::SCIP_EXPRGRAPHNODE_t) = @scip_ccall_check("SCIPexprgraphMoveNodeParents", (Ptr{SCIP_EXPRGRAPH}, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}, Ptr{SCIP_EXPRGRAPHNODE}), pointer(exprgraph), pointer(pointer(srcnode)), pointer(targetnode))
#SCIPexprgraphReleaseNode(exprgraph::SCIP_EXPRGRAPH_t, node::SCIP_EXPRGRAPHNODE_t) = @scip_ccall_check("SCIPexprgraphReleaseNode", (Ptr{SCIP_EXPRGRAPH}, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}), pointer(exprgraph), pointer(pointer(node)))
...
#SCIPexprgraphFree(exprgraph::SCIP_EXPRGRAPH_t) = @scip_ccall_check("SCIPexprgraphFree", (Ptr{Ptr{SCIP_EXPRGRAPH}},), pointer(pointer(exprgraph)))
#SCIPexprgraphAddNode(exprgraph::SCIP_EXPRGRAPH_t, node::SCIP_EXPRGRAPHNODE_t, mindepth, nchildren, children::SCIP_EXPRGRAPHNODE_t) = @scip_ccall_check("SCIPexprgraphAddNode", (Ptr{SCIP_EXPRGRAPH}, Ptr{SCIP_EXPRGRAPHNODE}, Int, Int, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}), pointer(exprgraph), pointer(node), mindepth, nchildren, pointer(pointer(children)))
#SCIPexprgraphAddConst(exprgraph::SCIP_EXPRGRAPH_t, constant::SCIP_Real, constnode::SCIP_EXPRGRAPHNODE_t) = @scip_ccall_check("SCIPexprgraphAddConst", (Ptr{SCIP_EXPRGRAPH}, SCIP_Real, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}), pointer(exprgraph), constant, pointer(pointer(constnode)))
#SCIPexprgraphAddExprtreeSum(exprgraph::SCIP_EXPRGRAPH_t, nexprtrees, exprtrees::SCIP_EXPRTREE_t, coefs::SCIP_Real_t, rootnode::SCIP_EXPRGRAPHNODE_t, rootnodeisnew::SCIP_Bool_t) = @scip_ccall_check("SCIPexprgraphAddExprtreeSum", (Ptr{SCIP_EXPRGRAPH}, Int, Ptr{Ptr{SCIP_EXPRTREE}}, Ptr{SCIP_Real}, Ptr{Ptr{SCIP_EXPRGRAPHNODE}}, Ptr{SCIP_Bool}), pointer(exprgraph), nexprtrees, pointer(pointer(exprtrees)), pointer(coefs), pointer(pointer(rootnode)), pointer(rootnodeisnew))
...
#SCIPexprgraphGetTree(exprgraph::SCIP_EXPRGRAPH_t, rootnode::SCIP_EXPRGRAPHNODE_t, exprtree::SCIP_EXPRTREE_t) = @scip_ccall_check("SCIPexprgraphGetTree", (Ptr{SCIP_EXPRGRAPH}, Ptr{SCIP_EXPRGRAPHNODE}, Ptr{Ptr{SCIP_EXPRTREE}}), pointer(exprgraph), pointer(rootnode), pointer(pointer(exprtree)))
#SCIPcreate(scip::SCIP_t) = @scip_ccall_check("SCIPcreate", (Ptr{Ptr{SCIP}},), pointer(pointer(scip)))
#SCIPfree(scip::SCIP_t) = @scip_ccall_check("SCIPfree", (Ptr{Ptr{SCIP}},), pointer(pointer(scip)))
...
#SCIPgetVarCopy(sourcescip::SCIP_t, targetscip::SCIP_t, sourcevar::SCIP_VAR_t, targetvar::SCIP_VAR_t, varmap::SCIP_HASHMAP_t, consmap::SCIP_HASHMAP_t, globalVar::SCIP_Bool, success::SCIP_Bool_t) = @scip_ccall_check("SCIPgetVarCopy", (Ptr{SCIP}, Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_HASHMAP}, Ptr{SCIP_HASHMAP}, SCIP_Bool, Ptr{SCIP_Bool}), pointer(sourcescip), pointer(targetscip), pointer(sourcevar), pointer(pointer(targetvar)), pointer(varmap), pointer(consmap), globalVar, pointer(success))
...
#SCIPchgLongintParam(scip::SCIP_t, param::SCIP_PARAM_t, value::SCIP_Longint) = @scip_ccall_check("SCIPchgLongintParam", (Ptr{SCIP}, Ptr{SCIP_PARAM}, Int64), pointer(scip), pointer(param), value)
...
#SCIPreleaseDialog(scip::SCIP_t, dialog::SCIP_DIALOG_t) = @scip_ccall_check("SCIPreleaseDialog", (Ptr{SCIP}, Ptr{Ptr{SCIP_DIALOG}}), pointer(scip), pointer(pointer(dialog)))
...
#SCIPreleaseVar(scip::SCIP_t, var::SCIP_VAR_t) = @scip_ccall_check("SCIPreleaseVar", (Ptr{SCIP}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), pointer(pointer(var)))
#SCIPtransformVar(scip::SCIP_t, var::SCIP_VAR_t, transvar::SCIP_VAR_t) = @scip_ccall_check("SCIPtransformVar", (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), pointer(var), pointer(pointer(transvar)))
#SCIPtransformVars(scip::SCIP_t, nvars, vars::SCIP_VAR_t, transvars::SCIP_VAR_t) = @scip_ccall_check("SCIPtransformVars", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), nvars, pointer(pointer(vars)), pointer(pointer(transvars)))
#SCIPgetTransformedVar(scip::SCIP_t, var::SCIP_VAR_t, transvar::SCIP_VAR_t) = @scip_ccall_check("SCIPgetTransformedVar", (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), pointer(var), pointer(pointer(transvar)))
#SCIPgetTransformedVars(scip::SCIP_t, nvars, vars::SCIP_VAR_t, transvars::SCIP_VAR_t) = @scip_ccall_check("SCIPgetTransformedVars", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), nvars, pointer(pointer(vars)), pointer(pointer(transvars)))
#SCIPgetNegatedVar(scip::SCIP_t, var::SCIP_VAR_t, negvar::SCIP_VAR_t) = @scip_ccall_check("SCIPgetNegatedVar", (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), pointer(var), pointer(pointer(negvar)))
#SCIPgetNegatedVars(scip::SCIP_t, nvars, vars::SCIP_VAR_t, negvars::SCIP_VAR_t) = @scip_ccall_check("SCIPgetNegatedVars", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}), pointer(scip), nvars, pointer(pointer(vars)), pointer(pointer(negvars)))
#SCIPgetBinvarRepresentative(scip::SCIP_t, var::SCIP_VAR_t, repvar::SCIP_VAR_t, negated::SCIP_Bool_t) = @scip_ccall_check("SCIPgetBinvarRepresentative", (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Bool}), pointer(scip), pointer(var), pointer(pointer(repvar)), pointer(negated))
#SCIPgetBinvarRepresentatives(scip::SCIP_t, nvars, vars::SCIP_VAR_t, repvars::SCIP_VAR_t, negated::SCIP_Bool_t) = @scip_ccall_check("SCIPgetBinvarRepresentatives", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Bool}), pointer(scip), nvars, pointer(pointer(vars)), pointer(pointer(repvars)), pointer(negated))
...
#SCIPgetProbvarSum(scip::SCIP_t, var::SCIP_VAR_t, scalar::SCIP_Real_t, constant::SCIP_Real_t) = @scip_ccall_check("SCIPgetProbvarSum", (Ptr{SCIP}, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}, Ptr{SCIP_Real}), pointer(scip), pointer(pointer(var)), pointer(scalar), pointer(constant))
#SCIPgetVarSols(scip::SCIP_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPgetVarSols", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), nvars, pointer(pointer(vars)), pointer(vals))
...
#SCIPsetRelaxSolVals(scip::SCIP_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPsetRelaxSolVals", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), nvars, pointer(pointer(vars)), pointer(vals))
...
#SCIPgetVarsStrongbranchesFrac(scip::SCIP_t, vars::SCIP_VAR_t, nvars, itlim, down::SCIP_Real_t, up::SCIP_Real_t, downvalid::SCIP_Bool_t, upvalid::SCIP_Bool_t, downinf::SCIP_Bool_t, upinf::SCIP_Bool_t, downconflict::SCIP_Bool_t, upconflict::SCIP_Bool_t, lperror::SCIP_Bool_t) = @scip_ccall_check("SCIPgetVarsStrongbranchesFrac", (Ptr{SCIP}, Ptr{Ptr{SCIP_VAR}}, Int, Int, Ptr{SCIP_Real}, Ptr{SCIP_Real}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}), pointer(scip), pointer(pointer(vars)), nvars, itlim, pointer(down), pointer(up), pointer(downvalid), pointer(upvalid), pointer(downinf), pointer(upinf), pointer(downconflict), pointer(upconflict), pointer(lperror))
#SCIPgetVarsStrongbranchesInt(scip::SCIP_t, vars::SCIP_VAR_t, nvars, itlim, down::SCIP_Real_t, up::SCIP_Real_t, downvalid::SCIP_Bool_t, upvalid::SCIP_Bool_t, downinf::SCIP_Bool_t, upinf::SCIP_Bool_t, downconflict::SCIP_Bool_t, upconflict::SCIP_Bool_t, lperror::SCIP_Bool_t) = @scip_ccall_check("SCIPgetVarsStrongbranchesInt", (Ptr{SCIP}, Ptr{Ptr{SCIP_VAR}}, Int, Int, Ptr{SCIP_Real}, Ptr{SCIP_Real}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}), pointer(scip), pointer(pointer(vars)), nvars, itlim, pointer(down), pointer(up), pointer(downvalid), pointer(upvalid), pointer(downinf), pointer(upinf), pointer(downconflict), pointer(upconflict), pointer(lperror))
...
#SCIPmultiaggregateVar(scip::SCIP_t, var::SCIP_VAR_t, naggvars, aggvars::SCIP_VAR_t, scalars::SCIP_Real_t, constant::SCIP_Real, infeasible::SCIP_Bool_t, aggregated::SCIP_Bool_t) = @scip_ccall_check("SCIPmultiaggregateVar", (Ptr{SCIP}, Ptr{SCIP_VAR}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}, SCIP_Real, Ptr{SCIP_Bool}, Ptr{SCIP_Bool}), pointer(scip), pointer(var), naggvars, pointer(pointer(aggvars)), pointer(scalars), constant, pointer(infeasible), pointer(aggregated))
...
#SCIPreleaseCons(scip::SCIP_t, cons::SCIP_CONS_t) = @scip_ccall_check("SCIPreleaseCons", (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}), pointer(scip), pointer(pointer(cons)))
...
#SCIPtransformCons(scip::SCIP_t, cons::SCIP_CONS_t, transcons::SCIP_CONS_t) = @scip_ccall_check("SCIPtransformCons", (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Ptr{SCIP_CONS}}), pointer(scip), pointer(cons), pointer(pointer(transcons)))
#SCIPtransformConss(scip::SCIP_t, nconss, conss::SCIP_CONS_t, transconss::SCIP_CONS_t) = @scip_ccall_check("SCIPtransformConss", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_CONS}}, Ptr{Ptr{SCIP_CONS}}), pointer(scip), nconss, pointer(pointer(conss)), pointer(pointer(transconss)))
#SCIPgetTransformedCons(scip::SCIP_t, cons::SCIP_CONS_t, transcons::SCIP_CONS_t) = @scip_ccall_check("SCIPgetTransformedCons", (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Ptr{SCIP_CONS}}), pointer(scip), pointer(cons), pointer(pointer(transcons)))
#SCIPgetTransformedConss(scip::SCIP_t, nconss, conss::SCIP_CONS_t, transconss::SCIP_CONS_t) = @scip_ccall_check("SCIPgetTransformedConss", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_CONS}}, Ptr{Ptr{SCIP_CONS}}), pointer(scip), nconss, pointer(pointer(conss)), pointer(pointer(transconss)))
...
#SCIPgetConsVars(scip::SCIP_t, cons::SCIP_CONS_t, vars::SCIP_VAR_t, varssize, success::SCIP_Bool_t) = @scip_ccall_check("SCIPgetConsVars", (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Ptr{SCIP_VAR}}, Int, Ptr{SCIP_Bool}), pointer(scip), pointer(cons), pointer(pointer(vars)), varssize, pointer(success))
...
#SCIPgetLPI(scip::SCIP_t, lpi::SCIP_LPI_t) = @scip_ccall_check("SCIPgetLPI", (Ptr{SCIP}, Ptr{Ptr{SCIP_LPI}}), pointer(scip), pointer(pointer(lpi)))
#SCIPcomputeLPRelIntPoint(scip::SCIP_t, relaxrows::SCIP_Bool, inclobjcutoff::SCIP_Bool, timelimit::SCIP_Real, iterlimit, point::SCIP_SOL_t) = @scip_ccall_check("SCIPcomputeLPRelIntPoint", (Ptr{SCIP}, SCIP_Bool, SCIP_Bool, SCIP_Real, Int, Ptr{Ptr{SCIP_SOL}}), pointer(scip), relaxrows, inclobjcutoff, timelimit, iterlimit, pointer(pointer(point)))
#SCIPcaptureRow(scip::SCIP_t, row::SCIP_ROW_t) = @scip_ccall_check("SCIPcaptureRow", (Ptr{SCIP}, Ptr{SCIP_ROW}), pointer(scip), pointer(row))
#SCIPreleaseRow(scip::SCIP_t, row::SCIP_ROW_t) = @scip_ccall_check("SCIPreleaseRow", (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}), pointer(scip), pointer(pointer(row)))
...
#SCIPaddVarsToRow(scip::SCIP_t, row::SCIP_ROW_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPaddVarsToRow", (Ptr{SCIP}, Ptr{SCIP_ROW}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), pointer(row), nvars, pointer(pointer(vars)), pointer(vals))
#SCIPaddVarsToRowSameCoef(scip::SCIP_t, row::SCIP_ROW_t, nvars, vars::SCIP_VAR_t, val::SCIP_Real) = @scip_ccall_check("SCIPaddVarsToRowSameCoef", (Ptr{SCIP}, Ptr{SCIP_ROW}, Int, Ptr{Ptr{SCIP_VAR}}, SCIP_Real), pointer(scip), pointer(row), nvars, pointer(pointer(vars)), val)
#SCIPcalcRowIntegralScalar(scip::SCIP_t, row::SCIP_ROW_t, mindelta::SCIP_Real, maxdelta::SCIP_Real, maxdnom::SCIP_Longint, maxscale::SCIP_Real, usecontvars::SCIP_Bool, intscalar::SCIP_Real_t, success::SCIP_Bool_t) = @scip_ccall_check("SCIPcalcRowIntegralScalar", (Ptr{SCIP}, Ptr{SCIP_ROW}, SCIP_Real, SCIP_Real, Int64, SCIP_Real, SCIP_Bool, Ptr{SCIP_Real}, Ptr{SCIP_Bool}), pointer(scip), pointer(row), mindelta, maxdelta, maxdnom, maxscale, usecontvars, pointer(intscalar), pointer(success))
#SCIPmakeRowIntegral(scip::SCIP_t, row::SCIP_ROW_t, mindelta::SCIP_Real, maxdelta::SCIP_Real, maxdnom::SCIP_Longint, maxscale::SCIP_Real, usecontvars::SCIP_Bool, success::SCIP_Bool_t) = @scip_ccall_check("SCIPmakeRowIntegral", (Ptr{SCIP}, Ptr{SCIP_ROW}, SCIP_Real, SCIP_Real, Int64, SCIP_Real, SCIP_Bool, Ptr{SCIP_Bool}), pointer(scip), pointer(row), mindelta, maxdelta, maxdnom, maxscale, usecontvars, pointer(success))
...
#SCIPgetNLPI(scip::SCIP_t, nlpi::SCIP_NLPI_t, nlpiproblem::SCIP_NLPIPROBLEM_t) = @scip_ccall_check("SCIPgetNLPI", (Ptr{SCIP}, Ptr{Ptr{SCIP_NLPI}}, Ptr{Ptr{SCIP_NLPIPROBLEM}}), pointer(scip), pointer(pointer(nlpi)), pointer(pointer(nlpiproblem)))
...
#SCIPchgVarsBoundsDiveNLP(scip::SCIP_t, nvars, vars::SCIP_VAR_t, lbs::SCIP_Real_t, ubs::SCIP_Real_t) = @scip_ccall_check("SCIPchgVarsBoundsDiveNLP", (Ptr{SCIP}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}, Ptr{SCIP_Real}), pointer(scip), nvars, pointer(pointer(vars)), pointer(lbs), pointer(ubs))
#SCIPsolveDiveNLP(scip::SCIP_t) = @scip_ccall_check("SCIPsolveDiveNLP", (Ptr{SCIP},), pointer(scip))
#SCIPcreateNlRowFromRow(scip::SCIP_t, nlrow::SCIP_NLROW_t, row::SCIP_ROW_t) = @scip_ccall_check("SCIPcreateNlRowFromRow", (Ptr{SCIP}, Ptr{Ptr{SCIP_NLROW}}, Ptr{SCIP_ROW}), pointer(scip), pointer(pointer(nlrow)), pointer(row))
...
#SCIPreleaseNlRow(scip::SCIP_t, nlrow::SCIP_NLROW_t) = @scip_ccall_check("SCIPreleaseNlRow", (Ptr{SCIP}, Ptr{Ptr{SCIP_NLROW}}), pointer(scip), pointer(pointer(nlrow)))
...
#SCIPaddLinearCoefsToNlRow(scip::SCIP_t, nlrow::SCIP_NLROW_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPaddLinearCoefsToNlRow", (Ptr{SCIP}, Ptr{SCIP_NLROW}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), pointer(nlrow), nvars, pointer(pointer(vars)), pointer(vals))
...
#SCIPaddQuadVarsToNlRow(scip::SCIP_t, nlrow::SCIP_NLROW_t, nvars, vars::SCIP_VAR_t) = @scip_ccall_check("SCIPaddQuadVarsToNlRow", (Ptr{SCIP}, Ptr{SCIP_NLROW}, Int, Ptr{Ptr{SCIP_VAR}}), pointer(scip), pointer(nlrow), nvars, pointer(pointer(vars)))
...
#SCIPcreateCutpool(scip::SCIP_t, cutpool::SCIP_CUTPOOL_t, agelimit) = @scip_ccall_check("SCIPcreateCutpool", (Ptr{SCIP}, Ptr{Ptr{SCIP_CUTPOOL}}, Int), pointer(scip), pointer(pointer(cutpool)), agelimit)
#SCIPfreeCutpool(scip::SCIP_t, cutpool::SCIP_CUTPOOL_t) = @scip_ccall_check("SCIPfreeCutpool", (Ptr{SCIP}, Ptr{Ptr{SCIP_CUTPOOL}}), pointer(scip), pointer(pointer(cutpool)))
...
#SCIPcreateChild(scip::SCIP_t, node::SCIP_NODE_t, nodeselprio::SCIP_Real, estimate::SCIP_Real) = @scip_ccall_check("SCIPcreateChild", (Ptr{SCIP}, Ptr{Ptr{SCIP_NODE}}, SCIP_Real, SCIP_Real), pointer(scip), pointer(pointer(node)), nodeselprio, estimate)
#SCIPbranchVar(scip::SCIP_t, var::SCIP_VAR_t, downchild::SCIP_NODE_t, eqchild::SCIP_NODE_t, upchild::SCIP_NODE_t) = @scip_ccall_check("SCIPbranchVar", (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{Ptr{SCIP_NODE}}, Ptr{Ptr{SCIP_NODE}}, Ptr{Ptr{SCIP_NODE}}), pointer(scip), pointer(var), pointer(pointer(downchild)), pointer(pointer(eqchild)), pointer(pointer(upchild)))
#SCIPbranchVarHole(scip::SCIP_t, var::SCIP_VAR_t, left::SCIP_Real, right::SCIP_Real, downchild::SCIP_NODE_t, upchild::SCIP_NODE_t) = @scip_ccall_check("SCIPbranchVarHole", (Ptr{SCIP}, Ptr{SCIP_VAR}, SCIP_Real, SCIP_Real, Ptr{Ptr{SCIP_NODE}}, Ptr{Ptr{SCIP_NODE}}), pointer(scip), pointer(var), left, right, pointer(pointer(downchild)), pointer(pointer(upchild)))
#SCIPbranchVarVal(scip::SCIP_t, var::SCIP_VAR_t, val::SCIP_Real, downchild::SCIP_NODE_t, eqchild::SCIP_NODE_t, upchild::SCIP_NODE_t) = @scip_ccall_check("SCIPbranchVarVal", (Ptr{SCIP}, Ptr{SCIP_VAR}, SCIP_Real, Ptr{Ptr{SCIP_NODE}}, Ptr{Ptr{SCIP_NODE}}, Ptr{Ptr{SCIP_NODE}}), pointer(scip), pointer(var), val, pointer(pointer(downchild)), pointer(pointer(eqchild)), pointer(pointer(upchild)))
...
#SCIPcreateSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateLPSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateLPSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateNLPSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateNLPSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateRelaxSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateRelaxSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreatePseudoSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreatePseudoSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateCurrentSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateCurrentSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateUnknownSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateUnknownSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateOrigSol(scip::SCIP_t, sol::SCIP_SOL_t, heur::SCIP_HEUR_t) = @scip_ccall_check("SCIPcreateOrigSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_HEUR}), pointer(scip), pointer(pointer(sol)), pointer(heur))
#SCIPcreateSolCopy(scip::SCIP_t, sol::SCIP_SOL_t, sourcesol::SCIP_SOL_t) = @scip_ccall_check("SCIPcreateSolCopy", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_SOL}), pointer(scip), pointer(pointer(sol)), pointer(sourcesol))
#SCIPcreateFiniteSolCopy(scip::SCIP_t, sol::SCIP_SOL_t, sourcesol::SCIP_SOL_t, success::SCIP_Bool_t) = @scip_ccall_check("SCIPcreateFiniteSolCopy", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_SOL}, Ptr{SCIP_Bool}), pointer(scip), pointer(pointer(sol)), pointer(sourcesol), pointer(success))
#SCIPfreeSol(scip::SCIP_t, sol::SCIP_SOL_t) = @scip_ccall_check("SCIPfreeSol", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}), pointer(scip), pointer(pointer(sol)))
...
#SCIPsetSolVals(scip::SCIP_t, sol::SCIP_SOL_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPsetSolVals", (Ptr{SCIP}, Ptr{SCIP_SOL}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), pointer(sol), nvars, pointer(pointer(vars)), pointer(vals))
...
#SCIPgetSolVals(scip::SCIP_t, sol::SCIP_SOL_t, nvars, vars::SCIP_VAR_t, vals::SCIP_Real_t) = @scip_ccall_check("SCIPgetSolVals", (Ptr{SCIP}, Ptr{SCIP_SOL}, Int, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_Real}), pointer(scip), pointer(sol), nvars, pointer(pointer(vars)), pointer(vals))
...
#SCIPaddSolFree(scip::SCIP_t, sol::SCIP_SOL_t, stored::SCIP_Bool_t) = @scip_ccall_check("SCIPaddSolFree", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, Ptr{SCIP_Bool}), pointer(scip), pointer(pointer(sol)), pointer(stored))
...
#SCIPtrySolFree(scip::SCIP_t, sol::SCIP_SOL_t, printreason::SCIP_Bool, checkbounds::SCIP_Bool, checkintegrality::SCIP_Bool, checklprows::SCIP_Bool, stored::SCIP_Bool_t) = @scip_ccall_check("SCIPtrySolFree", (Ptr{SCIP}, Ptr{Ptr{SCIP_SOL}}, SCIP_Bool, SCIP_Bool, SCIP_Bool, SCIP_Bool, Ptr{SCIP_Bool}), pointer(scip), pointer(pointer(sol)), printreason, checkbounds, checkintegrality, checklprows, pointer(stored))
...
#SCIPcreateClock(scip::SCIP_t, clck::SCIP_CLOCK_t) = @scip_ccall_check("SCIPcreateClock", (Ptr{SCIP}, Ptr{Ptr{SCIP_CLOCK}}), pointer(scip), pointer(pointer(clck)))
#SCIPcreateCPUClock(scip::SCIP_t, clck::SCIP_CLOCK_t) = @scip_ccall_check("SCIPcreateCPUClock", (Ptr{SCIP}, Ptr{Ptr{SCIP_CLOCK}}), pointer(scip), pointer(pointer(clck)))
#SCIPcreateWallClock(scip::SCIP_t, clck::SCIP_CLOCK_t) = @scip_ccall_check("SCIPcreateWallClock", (Ptr{SCIP}, Ptr{Ptr{SCIP_CLOCK}}), pointer(scip), pointer(pointer(clck)))
#SCIPfreeClock(scip::SCIP_t, clck::SCIP_CLOCK_t) = @scip_ccall_check("SCIPfreeClock", (Ptr{SCIP}, Ptr{Ptr{SCIP_CLOCK}}), pointer(scip), pointer(pointer(clck)))
...
#SCIPcreateRealarray(scip::SCIP_t, realarray::SCIP_REALARRAY_t) = @scip_ccall_check("SCIPcreateRealarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_REALARRAY}}), pointer(scip), pointer(pointer(realarray)))
#SCIPfreeRealarray(scip::SCIP_t, realarray::SCIP_REALARRAY_t) = @scip_ccall_check("SCIPfreeRealarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_REALARRAY}}), pointer(scip), pointer(pointer(realarray)))
...
#SCIPcreateIntarray(scip::SCIP_t, intarray::SCIP_INTARRAY_t) = @scip_ccall_check("SCIPcreateIntarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_INTARRAY}}), pointer(scip), pointer(pointer(intarray)))
#SCIPfreeIntarray(scip::SCIP_t, intarray::SCIP_INTARRAY_t) = @scip_ccall_check("SCIPfreeIntarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_INTARRAY}}), pointer(scip), pointer(pointer(intarray)))
...
#SCIPcreateBoolarray(scip::SCIP_t, boolarray::SCIP_BOOLARRAY_t) = @scip_ccall_check("SCIPcreateBoolarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_BOOLARRAY}}), pointer(scip), pointer(pointer(boolarray)))
#SCIPfreeBoolarray(scip::SCIP_t, boolarray::SCIP_BOOLARRAY_t) = @scip_ccall_check("SCIPfreeBoolarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_BOOLARRAY}}), pointer(scip), pointer(pointer(boolarray)))
...
#SCIPcreatePtrarray(scip::SCIP_t, ptrarray::SCIP_PTRARRAY_t) = @scip_ccall_check("SCIPcreatePtrarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_PTRARRAY}}), pointer(scip), pointer(pointer(ptrarray)))
#SCIPfreePtrarray(scip::SCIP_t, ptrarray::SCIP_PTRARRAY_t) = @scip_ccall_check("SCIPfreePtrarray", (Ptr{SCIP}, Ptr{Ptr{SCIP_PTRARRAY}}), pointer(scip), pointer(pointer(ptrarray)))
