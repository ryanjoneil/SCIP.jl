...
_SCIPbranchruleGetName(branchrule) = @scip_ccall("SCIPbranchruleGetName", 
    Ptr{Char}, (Ptr{_SCIP_BRANCHRULE},), branchrule)
...
_SCIPconflicthdlrGetName(conflicthdlr) = @scip_ccall("SCIPconflicthdlrGetName", 
    Ptr{Char}, (Ptr{_SCIP_CONFLICTHDLR},), conflicthdlr)
...
_SCIPconshdlrGetName(conshdlr) = @scip_ccall("SCIPconshdlrGetName", 
    Ptr{Char}, (Ptr{_SCIP_CONSHDLR},), conshdlr)
...
_SCIPdialogHasEntry(dialog, entryname) = @scip_ccall("SCIPdialogHasEntry", 
    _SCIP_Bool, (Ptr{_SCIP_DIALOG}, Ptr{Char},), dialog, entryname)
_SCIPdialogFindEntry(dialog, entryname, subdialog) = @scip_ccall("SCIPdialogFindEntry", 
    Int, (Ptr{_SCIP_DIALOG}, Ptr{Char}, Ptr{Ptr{_SCIP_DIALOG}},), dialog, entryname, subdialog)
_SCIPdialogGetPath(dialog, sepchar, path) = @scip_ccall("SCIPdialogGetPath", 
    Void, (Ptr{_SCIP_DIALOG}, Char, Ptr{Char},), dialog, sepchar, path)
_SCIPdialogGetName(dialog) = @scip_ccall("SCIPdialogGetName", 
    Ptr{Char}, (Ptr{_SCIP_DIALOG},), dialog)
...
_SCIPeventhdlrGetName(eventhdlr) = @scip_ccall("SCIPeventhdlrGetName", 
    Ptr{Char}, (Ptr{_SCIP_EVENTHDLR},), eventhdlr)
...
_SCIPexprcurvGetName(curv) = @scip_ccall("SCIPexprcurvGetName", 
    Ptr{Char}, (_SCIP_EXPRCURV,), curv)
_SCIPexpropGetName(op) = @scip_ccall("SCIPexpropGetName", 
    Ptr{Char}, (_SCIP_EXPROP,), op)
...
_SCIPmessagehdlrSetLogfile(messagehdlr, filename) = @scip_ccall("SCIPmessagehdlrSetLogfile", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, Ptr{Char},), messagehdlr, filename)
...
_SCIPmessageVPrintInfo(messagehdlr, formatstr, ap) = @scip_ccall("SCIPmessageVPrintInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, Ptr{Char}, va_list,), messagehdlr, formatstr, ap)
_SCIPmessageVFPrintInfo(messagehdlr, file, formatstr, ap) = @scip_ccall("SCIPmessageVFPrintInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, Ptr{FILE}, Ptr{Char}, va_list,), messagehdlr, file, formatstr, ap)
...
_SCIPmessageVPrintVerbInfo(messagehdlr, verblevel, msgverblevel, formatstr, ap) = @scip_ccall("SCIPmessageVPrintVerbInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, _SCIP_VERBLEVEL, _SCIP_VERBLEVEL, Ptr{Char}, va_list,), messagehdlr, verblevel, msgverblevel, formatstr, ap)
_SCIPmessageVFPrintVerbInfo(messagehdlr, verblevel, msgverblevel, file, formatstr, ap) = @scip_ccall("SCIPmessageVFPrintVerbInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, _SCIP_VERBLEVEL, _SCIP_VERBLEVEL, Ptr{FILE}, Ptr{Char}, va_list,), messagehdlr, verblevel, msgverblevel, file, formatstr, ap)
_SCIPmessagePrintErrorHeader(sourcefile, sourceline) = @scip_ccall("SCIPmessagePrintErrorHeader", 
    Void, (Ptr{Char}, Int,), sourcefile, sourceline)
_SCIPmessageVPrintError(formatstr, ap) = @scip_ccall("SCIPmessageVPrintError", 
    Void, (Ptr{Char}, va_list,), formatstr, ap)
...
_SCIPgmlWriteNode(file, id, label, nodetype, fillcolor, bordercolor) = @scip_ccall("SCIPgmlWriteNode", 
    Void, (Ptr{FILE}, Uint, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char},), file, id, label, nodetype, fillcolor, bordercolor)
_SCIPgmlWriteNodeWeight(file, id, label, nodetype, fillcolor, bordercolor, weight) = @scip_ccall("SCIPgmlWriteNodeWeight", 
    Void, (Ptr{FILE}, Uint, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{Char}, _SCIP_Real,), file, id, label, nodetype, fillcolor, bordercolor, weight)
_SCIPgmlWriteEdge(file, source, target, label, color) = @scip_ccall("SCIPgmlWriteEdge", 
    Void, (Ptr{FILE}, Uint, Uint, Ptr{Char}, Ptr{Char},), file, source, target, label, color)
...
_SCIPmemccpy(dest, src, stop, cnt) = @scip_ccall("SCIPmemccpy", 
    Int, (Ptr{Char}, Ptr{Char}, Char, Uint,), dest, src, stop, cnt)
...
_SCIPstrtok(s, delim, ptrptr) = @scip_ccall("SCIPstrtok", 
    Ptr{Char}, (Ptr{Char}, Ptr{Char}, Ptr{Ptr{Char}},), s, delim, ptrptr)
_SCIPescapeString(t, bufsize, s) = @scip_ccall("SCIPescapeString", 
    Void, (Ptr{Char}, Int, Ptr{Char},), t, bufsize, s)
_SCIPstrToIntValue(str, value, endptr) = @scip_ccall("SCIPstrToIntValue", 
    _SCIP_Bool, (Ptr{Char}, Ptr{Int}, Ptr{Ptr{Char}},), str, value, endptr)
_SCIPstrToRealValue(str, value, endptr) = @scip_ccall("SCIPstrToRealValue", 
    _SCIP_Bool, (Ptr{Char}, Ptr{_SCIP_Real}, Ptr{Ptr{Char}},), str, value, endptr)
_SCIPstrCopySection(str, startchar, endchar, token, size, endptr) = @scip_ccall("SCIPstrCopySection", 
    Void, (Ptr{Char}, Char, Char, Ptr{Char}, Int, Ptr{Ptr{Char}},), str, startchar, endchar, token, size, endptr)
_SCIPfileExists(filename) = @scip_ccall("SCIPfileExists", 
    _SCIP_Bool, (Ptr{Char},), filename)
...
_SCIPnlrowGetName(nlrow) = @scip_ccall("SCIPnlrowGetName", 
    Ptr{Char}, (Ptr{_SCIP_NLROW},), nlrow)
...
_SCIPnodeselGetName(nodesel) = @scip_ccall("SCIPnodeselGetName", 
    Ptr{Char}, (Ptr{_SCIP_NODESEL},), nodesel)
...
_SCIPpresolGetName(presol) = @scip_ccall("SCIPpresolGetName", 
    Ptr{Char}, (Ptr{_SCIP_PRESOL},), presol)
...
_SCIPpricerGetName(pricer) = @scip_ccall("SCIPpricerGetName", 
    Ptr{Char}, (Ptr{_SCIP_PRICER},), pricer)
...
_SCIPreaderGetName(reader) = @scip_ccall("SCIPreaderGetName", 
    Ptr{Char}, (Ptr{_SCIP_READER},), reader)
...
_SCIPrelaxGetName(relax) = @scip_ccall("SCIPrelaxGetName", 
    Ptr{Char}, (Ptr{_SCIP_RELAX},), relax)
...
_SCIPsetMessagehdlrLogfile(scip, filename) = @scip_ccall("SCIPsetMessagehdlrLogfile", 
    Void, (Ptr{_SCIP}, Ptr{Char},), scip, filename)
...
_SCIPisParamFixed(scip, name) = @scip_ccall("SCIPisParamFixed", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{Char},), scip, name)
_SCIPgetParam(scip, name) = @scip_ccall("SCIPgetParam", 
    Ptr{_SCIP_PARAM}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindReader(scip, name) = @scip_ccall("SCIPfindReader", 
    Ptr{_SCIP_READER}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindPricer(scip, name) = @scip_ccall("SCIPfindPricer", 
    Ptr{_SCIP_PRICER}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindConshdlr(scip, name) = @scip_ccall("SCIPfindConshdlr", 
    Ptr{_SCIP_CONSHDLR}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindConflicthdlr(scip, name) = @scip_ccall("SCIPfindConflicthdlr", 
    Ptr{_SCIP_CONFLICTHDLR}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindPresol(scip, name) = @scip_ccall("SCIPfindPresol", 
    Ptr{_SCIP_PRESOL}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindRelax(scip, name) = @scip_ccall("SCIPfindRelax", 
    Ptr{_SCIP_RELAX}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindSepa(scip, name) = @scip_ccall("SCIPfindSepa", 
    Ptr{_SCIP_SEPA}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindProp(scip, name) = @scip_ccall("SCIPfindProp", 
    Ptr{_SCIP_PROP}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindHeur(scip, name) = @scip_ccall("SCIPfindHeur", 
    Ptr{_SCIP_HEUR}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindEventhdlr(scip, name) = @scip_ccall("SCIPfindEventhdlr", 
    Ptr{_SCIP_EVENTHDLR}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindNodesel(scip, name) = @scip_ccall("SCIPfindNodesel", 
    Ptr{_SCIP_NODESEL}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindBranchrule(scip, name) = @scip_ccall("SCIPfindBranchrule", 
    Ptr{_SCIP_BRANCHRULE}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindDisp(scip, name) = @scip_ccall("SCIPfindDisp", 
    Ptr{_SCIP_DISP}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPfindNlpi(scip, name) = @scip_ccall("SCIPfindNlpi", 
    Ptr{_SCIP_NLPI}, (Ptr{_SCIP}, Ptr{Char},), scip, name)
...
_SCIPcreateConsAbspower(scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsAbspower", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicAbspower(scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicAbspower", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs)
...
_SCIPcreateConsAnd(scip, cons, name, resvar, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsAnd", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, resvar, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicAnd(scip, cons, name, resvar, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicAnd", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, resvar, nvars, vars)
...
_SCIPcreateConsBivariate(scip, cons, name, f, convextype, z, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsBivariate", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_EXPRTREE}, _SCIP_BIVAR_CONVEXITY, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, f, convextype, z, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicBivariate(scip, cons, name, f, convextype, z, zcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicBivariate", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_EXPRTREE}, _SCIP_BIVAR_CONVEXITY, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, f, convextype, z, zcoef, lhs, rhs)
...
_SCIPcreateConsBounddisjunction(scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsBounddisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_BOUNDTYPE}, Ptr{_SCIP_Real}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicBounddisjunction(scip, cons, name, nvars, vars, boundtypes, bounds) = @scip_ccall_check("SCIPcreateConsBasicBounddisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_BOUNDTYPE}, Ptr{_SCIP_Real},), scip, cons, name, nvars, vars, boundtypes, bounds)
...
_SCIPcreateConsConjunction(scip, cons, name, nconss, conss, enforce, check, localVar, modifiable, dynamic) = @scip_ccall_check("SCIPcreateConsConjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_CONS}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nconss, conss, enforce, check, localVar, modifiable, dynamic)
_SCIPcreateConsBasicConjunction(scip, cons, name, nconss, conss) = @scip_ccall_check("SCIPcreateConsBasicConjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_CONS}},), scip, cons, name, nconss, conss)
...
_SCIPcreateConsBasicCumulative(scip, cons, name, nvars, vars, durations, demands, capacity) = @scip_ccall_check("SCIPcreateConsBasicCumulative", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int}, Ptr{Int}, Int,), scip, cons, name, nvars, vars, durations, demands, capacity)
...
_SCIPcreateConsDisjunction(scip, cons, name, nconss, conss, relaxcons, initial, enforce, check, localVar, modifiable, dynamic) = @scip_ccall_check("SCIPcreateConsDisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONS}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nconss, conss, relaxcons, initial, enforce, check, localVar, modifiable, dynamic)
_SCIPcreateConsBasicDisjunction(scip, cons, name, nconss, conss, relaxcons) = @scip_ccall_check("SCIPcreateConsBasicDisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONS},), scip, cons, name, nconss, conss, relaxcons)
...
_SCIPcreateConsIndicator(scip, cons, name, binvar, nvars, vars, vals, rhs, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsIndicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, nvars, vars, vals, rhs, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicIndicator(scip, cons, name, binvar, nvars, vars, vals, rhs) = @scip_ccall_check("SCIPcreateConsBasicIndicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real,), scip, cons, name, binvar, nvars, vars, vals, rhs)
_SCIPcreateConsIndicatorLinCons(scip, cons, name, binvar, lincons, slackvar, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsIndicatorLinCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, lincons, slackvar, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicIndicatorLinCons(scip, cons, name, binvar, lincons, slackvar) = @scip_ccall_check("SCIPcreateConsBasicIndicatorLinCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR},), scip, cons, name, binvar, lincons, slackvar)
...
_SCIPcreateConsKnapsack(scip, cons, name, nvars, vars, weights, capacity, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsKnapsack", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int64}, Int64, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, weights, capacity, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicKnapsack(scip, cons, name, nvars, vars, weights, capacity) = @scip_ccall_check("SCIPcreateConsBasicKnapsack", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int64}, Int64,), scip, cons, name, nvars, vars, weights, capacity)
...
_SCIPcreateConsLinear(scip, cons, name, nvars, vars, vals, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, vals, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicLinear(scip, cons, name, nvars, vars, vals, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nvars, vars, vals, lhs, rhs)
_SCIPcopyConsLinear(scip, cons, sourcescip, name, nvars, sourcevars, sourcecoefs, lhs, rhs, varmap, consmap, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, valid) = @scip_ccall_check("SCIPcopyConsLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), scip, cons, sourcescip, name, nvars, sourcevars, sourcecoefs, lhs, rhs, varmap, consmap, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, valid)
...
_SCIPcreateConsLogicor(scip, cons, name, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsLogicor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicLogicor(scip, cons, name, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicLogicor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, nvars, vars)
...
_SCIPcreateConsNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsNonlinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_EXPRTREE}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicNonlinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_EXPRTREE}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs)
_SCIPcreateConsNonlinear2(scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsNonlinear2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_EXPRGRAPHNODE}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicNonlinear2(scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicNonlinear2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_EXPRGRAPHNODE}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs)
...
_SCIPcreateConsOrbitope(scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsOrbitope", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{Ptr{Ptr{_SCIP_VAR}}}, _SCIP_Bool, Int, Int, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicOrbitope(scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop) = @scip_ccall_check("SCIPcreateConsBasicOrbitope", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{Ptr{Ptr{_SCIP_VAR}}}, _SCIP_Bool, Int, Int, _SCIP_Bool,), scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop)
...
_SCIPcreateConsPseudobooleanWithConss(scip, cons, name, lincons, linconstype, andconss, andcoefs, nandconss, indvar, weight, issoftcons, intvar, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsPseudobooleanWithConss", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_CONS}, _SCIP_LINEARCONSTYPE, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Bool, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, lincons, linconstype, andconss, andcoefs, nandconss, indvar, weight, issoftcons, intvar, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
...
_SCIPcreateConsQuadratic(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoeffs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsQuadratic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoeffs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicQuadratic(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicQuadratic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs)
_SCIPcreateConsQuadratic2(scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsQuadratic2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_QUADVARTERM}, Int, Ptr{_SCIP_BILINTERM}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicQuadratic2(scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicQuadratic2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_QUADVARTERM}, Int, Ptr{_SCIP_BILINTERM}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs)
...
_SCIPcreateConsSOC(scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsSOC", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, _SCIP_Real, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicSOC(scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset) = @scip_ccall_check("SCIPcreateConsBasicSOC", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, _SCIP_Real, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset)
...
_SCIPcreateConsSOS1(scip, cons, name, nvars, vars, weights, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsSOS1", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, weights, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicSOS1(scip, cons, name, nvars, vars, weights) = @scip_ccall_check("SCIPcreateConsBasicSOS1", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real},), scip, cons, name, nvars, vars, weights)
...
_SCIPcreateConsSuperindicator(scip, cons, name, binvar, slackcons, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsSuperindicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, slackcons, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicSuperindicator(scip, cons, name, binvar, slackcons) = @scip_ccall_check("SCIPcreateConsBasicSuperindicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS},), scip, cons, name, binvar, slackcons)
...
_SCIPcreateConsVarbound(scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsVarbound", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicVarbound(scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicVarbound", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs)
...
_SCIPcreateConsXor(scip, cons, name, rhs, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsXor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, _SCIP_Bool, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, rhs, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicXor(scip, cons, name, rhs, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicXor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, _SCIP_Bool, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, rhs, nvars, vars)
_SCIPdialoghdlrGetWord(dialoghdlr, dialog, prompt, inputword, endoffile) = @scip_ccall_check("SCIPdialoghdlrGetWord", 
    (Ptr{_SCIP_DIALOGHDLR}, Ptr{_SCIP_DIALOG}, Ptr{Char}, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), dialoghdlr, dialog, prompt, inputword, endoffile)
_SCIPdialoghdlrAddInputLine(dialoghdlr, inputline) = @scip_ccall_check("SCIPdialoghdlrAddInputLine", 
    (Ptr{_SCIP_DIALOGHDLR}, Ptr{Char},), dialoghdlr, inputline)
_SCIPdialoghdlrAddHistory(dialoghdlr, dialog, command, escapecommand) = @scip_ccall_check("SCIPdialoghdlrAddHistory", 
    (Ptr{_SCIP_DIALOGHDLR}, Ptr{_SCIP_DIALOG}, Ptr{Char}, _SCIP_Bool,), dialoghdlr, dialog, command, escapecommand)
...
_SCIPdialogDisplayCompletions(dialog, scip, entryname) = @scip_ccall_check("SCIPdialogDisplayCompletions", 
    (Ptr{_SCIP_DIALOG}, Ptr{_SCIP}, Ptr{Char},), dialog, scip, entryname)
...
_SCIPexprParse(blkmem, messagehdlr, expr, str, lastchar, nvars, varnames) = @scip_ccall_check("SCIPexprParse", 
    (Ptr{BMS_BLKMEM}, Ptr{_SCIP_MESSAGEHDLR}, Ptr{Ptr{_SCIP_EXPR}}, Ptr{Char}, Ptr{Char}, Ptr{Int}, Ptr{Int},), blkmem, messagehdlr, expr, str, lastchar, nvars, varnames)
...
_SCIPcopyProb(sourcescip, targetscip, varmap, consmap, globalVar, name) = @scip_ccall_check("SCIPcopyProb", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, _SCIP_Bool, Ptr{Char},), sourcescip, targetscip, varmap, consmap, globalVar, name)
_SCIPcopyOrigProb(sourcescip, targetscip, varmap, consmap, name) = @scip_ccall_check("SCIPcopyOrigProb", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, Ptr{Char},), sourcescip, targetscip, varmap, consmap, name)
...
_SCIPgetConsCopy(sourcescip, targetscip, sourcecons, targetcons, sourceconshdlr, varmap, consmap, name, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, success) = @scip_ccall_check("SCIPgetConsCopy", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), sourcescip, targetscip, sourcecons, targetcons, sourceconshdlr, varmap, consmap, name, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, success)
...
_SCIPcopy(sourcescip, targetscip, varmap, consmap, suffix, globalVar, enablepricing, passmessagehdlr, valid) = @scip_ccall_check("SCIPcopy", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), sourcescip, targetscip, varmap, consmap, suffix, globalVar, enablepricing, passmessagehdlr, valid)
...
_SCIPsetBoolParam(scip, name, value) = @scip_ccall_check("SCIPsetBoolParam", 
    (Ptr{_SCIP}, Ptr{Char}, _SCIP_Bool,), scip, name, value)
...
_SCIPsetIntParam(scip, name, value) = @scip_ccall_check("SCIPsetIntParam", 
    (Ptr{_SCIP}, Ptr{Char}, Int,), scip, name, value)
...
_SCIPsetLongintParam(scip, name, value) = @scip_ccall_check("SCIPsetLongintParam", 
    (Ptr{_SCIP}, Ptr{Char}, Int64,), scip, name, value)
...
_SCIPsetRealParam(scip, name, value) = @scip_ccall_check("SCIPsetRealParam", 
    (Ptr{_SCIP}, Ptr{Char}, _SCIP_Real,), scip, name, value)
...
_SCIPsetCharParam(scip, name, value) = @scip_ccall_check("SCIPsetCharParam", 
    (Ptr{_SCIP}, Ptr{Char}, Char,), scip, name, value)
_SCIPchgStringParam(scip, param, value) = @scip_ccall_check("SCIPchgStringParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, Ptr{Char},), scip, param, value)
...
_SCIPreadParams(scip, filename) = @scip_ccall_check("SCIPreadParams", 
    (Ptr{_SCIP}, Ptr{Char},), scip, filename)
_SCIPwriteParams(scip, filename, comments, onlychanged) = @scip_ccall_check("SCIPwriteParams", 
    (Ptr{_SCIP}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool,), scip, filename, comments, onlychanged)
...
_SCIPincludeReaderBasic(scip, readerptr, name, desc, extension, readerdata) = @scip_ccall_check("SCIPincludeReaderBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_READER}}, Ptr{Char}, Ptr{Char}, Ptr{Char}, Ptr{_SCIP_READERDATA},), scip, readerptr, name, desc, extension, readerdata)
...
_SCIPincludeBranchruleBasic(scip, branchruleptr, name, desc, priority, maxdepth, maxbounddist, branchruledata) = @scip_ccall_check("SCIPincludeBranchruleBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_BRANCHRULE}}, Ptr{Char}, Ptr{Char}, Int, Int, _SCIP_Real, Ptr{_SCIP_BRANCHRULEDATA},), scip, branchruleptr, name, desc, priority, maxdepth, maxbounddist, branchruledata)
...
_SCIPincludeExternalCodeInformation(scip, name, description) = @scip_ccall_check("SCIPincludeExternalCodeInformation", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Char},), scip, name, description)
...
_SCIPaddDialogInputLine(scip, inputline) = @scip_ccall_check("SCIPaddDialogInputLine", 
    (Ptr{_SCIP}, Ptr{Char},), scip, inputline)
...
_SCIPreadProb(scip, filename, extension) = @scip_ccall_check("SCIPreadProb", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Char},), scip, filename, extension)
_SCIPwriteOrigProblem(scip, filename, extension, genericnames) = @scip_ccall_check("SCIPwriteOrigProblem", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Char}, _SCIP_Bool,), scip, filename, extension, genericnames)
...
_SCIPcreateVarBasic(scip, var, name, lb, ub, obj, vartype) = @scip_ccall_check("SCIPcreateVarBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_VAR}}, Ptr{Char}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_VARTYPE,), scip, var, name, lb, ub, obj, vartype)
...
_SCIPparseVarName(scip, str, var, endptr) = @scip_ccall_check("SCIPparseVarName", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{Char}},), scip, str, var, endptr)
_SCIPparseVarsList(scip, str, vars, nvars, varssize, requiredsize, endptr, delimiter, success) = @scip_ccall_check("SCIPparseVarsList", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int}, Int, Ptr{Int}, Ptr{Ptr{Char}}, Char, Ptr{_SCIP_Bool},), scip, str, vars, nvars, varssize, requiredsize, endptr, delimiter, success)
_SCIPparseVarsLinearsum(scip, str, vars, vals, nvars, varssize, requiredsize, endptr, success) = @scip_ccall_check("SCIPparseVarsLinearsum", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{Int}, Int, Ptr{Int}, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), scip, str, vars, vals, nvars, varssize, requiredsize, endptr, success)
_SCIPparseVarsPolynomial(scip, str, monomialvars, monomialexps, monomialcoefs, monomialnvars, nmonomials, endptr, success) = @scip_ccall_check("SCIPparseVarsPolynomial", 
    (Ptr{_SCIP}, Ptr{Char}, Ptr{Ptr{Ptr{Ptr{_SCIP_VAR}}}}, Ptr{Ptr{Ptr{_SCIP_Real}}}, Ptr{Ptr{_SCIP_Real}}, Ptr{Ptr{Int}}, Ptr{Int}, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), scip, str, monomialvars, monomialexps, monomialcoefs, monomialnvars, nmonomials, endptr, success)
...
_SCIPchgVarName(scip, var, name) = @scip_ccall_check("SCIPchgVarName", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, Ptr{Char},), scip, var, name)
...
_SCIPwriteCliqueGraph(scip, fname, writeimplications, writenodeweights) = @scip_ccall_check("SCIPwriteCliqueGraph", 
    (Ptr{_SCIP}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool,), scip, fname, writeimplications, writenodeweights)
...
_SCIPcreateCons(scip, cons, name, conshdlr, consdata, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_CONSDATA}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, conshdlr, consdata, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPparseCons(scip, cons, str, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, success) = @scip_ccall_check("SCIPparseCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), scip, cons, str, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, success)
...
_SCIPchgConsName(scip, cons, name) = @scip_ccall_check("SCIPchgConsName", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{Char},), scip, cons, name)
...
_SCIPwriteMIP(scip, filename, genericnames, origobj, lazyconss) = @scip_ccall_check("SCIPwriteMIP", 
    (Ptr{_SCIP}, Ptr{Char}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, filename, genericnames, origobj, lazyconss)
...
_SCIPcreateRowCons(scip, row, conshdlr, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_CONSHDLR}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, conshdlr, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateRowSepa(scip, row, sepa, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowSepa", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_SEPA}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, sepa, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateRowUnspec(scip, row, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowUnspec", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{Char}, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
...
_SCIPcreateEmptyRowCons(scip, row, conshdlr, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_CONSHDLR}, Ptr{Char}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, conshdlr, name, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateEmptyRowSepa(scip, row, sepa, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowSepa", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_SEPA}, Ptr{Char}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, sepa, name, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateEmptyRowUnspec(scip, row, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowUnspec", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{Char}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, name, lhs, rhs, localVar, modifiable, removable)
...
_SCIPsetNLPStringPar(scip, typeVar, sval) = @scip_ccall_check("SCIPsetNLPStringPar", 
    (Ptr{_SCIP}, _SCIP_NLPPARAM, Ptr{Char},), scip, typeVar, sval)
...
_SCIPcreateNlRow(scip, nlrow, name, constant, nlinvars, linvars, lincoefs, nquadvars, quadvars, nquadelems, quadelems, expression, lhs, rhs) = @scip_ccall_check("SCIPcreateNlRow", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_NLROW}}, Ptr{Char}, _SCIP_Real, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Int, Ptr{_SCIP_QUADELEM}, Ptr{_SCIP_EXPRTREE}, _SCIP_Real, _SCIP_Real,), scip, nlrow, name, constant, nlinvars, linvars, lincoefs, nquadvars, quadvars, nquadelems, quadelems, expression, lhs, rhs)
_SCIPcreateEmptyNlRow(scip, nlrow, name, lhs, rhs) = @scip_ccall_check("SCIPcreateEmptyNlRow", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_NLROW}}, Ptr{Char}, _SCIP_Real, _SCIP_Real,), scip, nlrow, name, lhs, rhs)
...
_SCIPprintOrigProblem(scip, file, extension, genericnames) = @scip_ccall_check("SCIPprintOrigProblem", 
    (Ptr{_SCIP}, Ptr{FILE}, Ptr{Char}, _SCIP_Bool,), scip, file, extension, genericnames)
...
_SCIPduplicateBufferSize(scip, ptr, source, size) = @scip_ccall_check("SCIPduplicateBufferSize", 
    (Ptr{_SCIP}, Ptr{Ptr{Void}}, Ptr{const void}, Int,), scip, ptr, source, size)
