...
_SCIPisLinearLocalQuadratic(scip, cons) = @scip_ccall("SCIPisLinearLocalQuadratic", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{_SCIP_CONS},), scip, cons)
_SCIPaddSquareLinearization(scip, sqrcoef, refpoint, isint, lincoef, linconstant, success) = @scip_ccall("SCIPaddSquareLinearization", 
    Void, (Ptr{_SCIP}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), scip, sqrcoef, refpoint, isint, lincoef, linconstant, success)
_SCIPaddSquareSecant(scip, sqrcoef, lb, ub, refpoint, lincoef, linconstant, success) = @scip_ccall("SCIPaddSquareSecant", 
    Void, (Ptr{_SCIP}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), scip, sqrcoef, lb, ub, refpoint, lincoef, linconstant, success)
_SCIPaddBilinLinearization(scip, bilincoef, refpointx, refpointy, lincoefx, lincoefy, linconstant, success) = @scip_ccall("SCIPaddBilinLinearization", 
    Void, (Ptr{_SCIP}, _SCIP_Real, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), scip, bilincoef, refpointx, refpointy, lincoefx, lincoefy, linconstant, success)
_SCIPaddBilinMcCormick(scip, bilincoef, lbx, ubx, refpointx, lby, uby, refpointy, overestimate, lincoefx, lincoefy, linconstant, success) = @scip_ccall("SCIPaddBilinMcCormick", 
    Void, (Ptr{_SCIP}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), scip, bilincoef, lbx, ubx, refpointx, lby, uby, refpointy, overestimate, lincoefx, lincoefy, linconstant, success)
...
_SCIPgetWeightsSOS1(scip, cons) = @scip_ccall("SCIPgetWeightsSOS1", 
    Ptr{_SCIP_Real}, (Ptr{_SCIP}, Ptr{_SCIP_CONS},), scip, cons)
_SCIPgetConflictgraphSOS1(conshdlr) = @scip_ccall("SCIPgetConflictgraphSOS1", 
    Ptr{_SCIP_DIGRAPH}, (Ptr{_SCIP_CONSHDLR},), conshdlr)
_SCIPgetNSOS1Vars(conshdlr) = @scip_ccall("SCIPgetNSOS1Vars", 
    Int, (Ptr{_SCIP_CONSHDLR},), conshdlr)
_SCIPvarIsSOS1(conshdlr, var) = @scip_ccall("SCIPvarIsSOS1", 
    _SCIP_Bool, (Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_VAR},), conshdlr, var)
_SCIPvarGetNodeSOS1(conshdlr, var) = @scip_ccall("SCIPvarGetNodeSOS1", 
    Int, (Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_VAR},), conshdlr, var)
_SCIPnodeGetVarSOS1(conflictgraph, node) = @scip_ccall("SCIPnodeGetVarSOS1", 
    Ptr{_SCIP_VAR}, (Ptr{_SCIP_DIGRAPH}, Int,), conflictgraph, node)
...
_SCIPbranchruleGetName(branchrule) = @scip_ccall("SCIPbranchruleGetName", 
    String, (Ptr{_SCIP_BRANCHRULE},), branchrule)
...
_SCIPcomprGetData(compr) = @scip_ccall("SCIPcomprGetData", 
    Ptr{_SCIP_COMPRDATA}, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprSetData(compr, comprdata) = @scip_ccall("SCIPcomprSetData", 
    Void, (Ptr{_SCIP_COMPR}, Ptr{_SCIP_COMPRDATA},), compr, comprdata)
_SCIPcomprGetName(heur) = @scip_ccall("SCIPcomprGetName", 
    String, (Ptr{_SCIP_COMPR},), heur)
_SCIPcomprGetDesc(compr) = @scip_ccall("SCIPcomprGetDesc", 
    String, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetPriority(compr) = @scip_ccall("SCIPcomprGetPriority", 
    Int, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetMinNodes(compr) = @scip_ccall("SCIPcomprGetMinNodes", 
    Int, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetNCalls(compr) = @scip_ccall("SCIPcomprGetNCalls", 
    Int64, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetNFound(compr) = @scip_ccall("SCIPcomprGetNFound", 
    Int64, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprIsInitialized(compr) = @scip_ccall("SCIPcomprIsInitialized", 
    _SCIP_Bool, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetSetupTime(compr) = @scip_ccall("SCIPcomprGetSetupTime", 
    _SCIP_Real, (Ptr{_SCIP_COMPR},), compr)
_SCIPcomprGetTime(compr) = @scip_ccall("SCIPcomprGetTime", 
    _SCIP_Real, (Ptr{_SCIP_COMPR},), compr)
...
_SCIPconflicthdlrGetName(conflicthdlr) = @scip_ccall("SCIPconflicthdlrGetName", 
    String, (Ptr{_SCIP_CONFLICTHDLR},), conflicthdlr)
...
_SCIPconshdlrGetName(conshdlr) = @scip_ccall("SCIPconshdlrGetName", 
    String, (Ptr{_SCIP_CONSHDLR},), conshdlr)
...
_SCIPconshdlrIsClonable(conshdlr) = @scip_ccall("SCIPconshdlrIsClonable", 
    _SCIP_Bool, (Ptr{_SCIP_CONSHDLR},), conshdlr)
_SCIPconshdlrGetPropTiming(conshdlr) = @scip_ccall("SCIPconshdlrGetPropTiming", 
    _SCIP_PROPTIMING, (Ptr{_SCIP_CONSHDLR},), conshdlr)
_SCIPconshdlrSetPropTiming(conshdlr, proptiming) = @scip_ccall("SCIPconshdlrSetPropTiming", 
    Void, (Ptr{_SCIP_CONSHDLR}, _SCIP_PROPTIMING,), conshdlr, proptiming)
_SCIPconshdlrGetPresolTiming(conshdlr) = @scip_ccall("SCIPconshdlrGetPresolTiming", 
    _SCIP_PRESOLTIMING, (Ptr{_SCIP_CONSHDLR},), conshdlr)
_SCIPconshdlrSetPresolTiming(conshdlr, presoltiming) = @scip_ccall("SCIPconshdlrSetPresolTiming", 
    Void, (Ptr{_SCIP_CONSHDLR}, _SCIP_PRESOLTIMING,), conshdlr, presoltiming)
_SCIPconsGetName(cons) = @scip_ccall("SCIPconsGetName", 
    String, (Ptr{_SCIP_CONS},), cons)
...
_SCIPcutGetLPActivityQuot(cut) = @scip_ccall("SCIPcutGetLPActivityQuot", 
    _SCIP_Real, (Ptr{_SCIP_CUT},), cut)
...
_SCIPdialogHasEntry(dialog, entryname) = @scip_ccall("SCIPdialogHasEntry", 
    _SCIP_Bool, (Ptr{_SCIP_DIALOG}, String,), dialog, entryname)
_SCIPdialogFindEntry(dialog, entryname, subdialog) = @scip_ccall("SCIPdialogFindEntry", 
    Int, (Ptr{_SCIP_DIALOG}, String, Ptr{Ptr{_SCIP_DIALOG}},), dialog, entryname, subdialog)
_SCIPdialogGetPath(dialog, sepchar, path) = @scip_ccall("SCIPdialogGetPath", 
    Void, (Ptr{_SCIP_DIALOG}, Char, String,), dialog, sepchar, path)
_SCIPdialogGetName(dialog) = @scip_ccall("SCIPdialogGetName", 
    String, (Ptr{_SCIP_DIALOG},), dialog)
...
_SCIPeventhdlrGetName(eventhdlr) = @scip_ccall("SCIPeventhdlrGetName", 
    String, (Ptr{_SCIP_EVENTHDLR},), eventhdlr)
...
_SCIPexprGetUserData(expr) = @scip_ccall("SCIPexprGetUserData", 
    Ptr{_SCIP_USEREXPRDATA}, (Ptr{_SCIP_EXPR},), expr)
_SCIPexprHasUserEstimator(expr) = @scip_ccall("SCIPexprHasUserEstimator", 
    _SCIP_Bool, (Ptr{_SCIP_EXPR},), expr)
_SCIPexprGetUserEvalCapability(expr) = @scip_ccall("SCIPexprGetUserEvalCapability", 
    _SCIP_EXPRINTCAPABILITY, (Ptr{_SCIP_EXPR},), expr)
...
_SCIPexprPrint(expr, messagehdlr, file, varnames, paramnames, paramvals) = @scip_ccall("SCIPexprPrint", 
    Void, (Ptr{_SCIP_EXPR}, Ptr{_SCIP_MESSAGEHDLR}, Ptr{FILE}, Ptr{Ptr{Char}}, Ptr{Ptr{Char}}, Ptr{_SCIP_Real},), expr, messagehdlr, file, varnames, paramnames, paramvals)
...
_SCIPexprtreePrint(tree, messagehdlr, file, varnames, paramnames) = @scip_ccall("SCIPexprtreePrint", 
    Void, (Ptr{_SCIP_EXPRTREE}, Ptr{_SCIP_MESSAGEHDLR}, Ptr{FILE}, Ptr{Ptr{Char}}, Ptr{Ptr{Char}},), tree, messagehdlr, file, varnames, paramnames)
...
_SCIPexprgraphGetNodePolynomialConstant(node) = @scip_ccall("SCIPexprgraphGetNodePolynomialConstant", 
    _SCIP_Real, (Ptr{_SCIP_EXPRGRAPHNODE},), node)
_SCIPexprgraphGetNodeUserData(node) = @scip_ccall("SCIPexprgraphGetNodeUserData", 
    Ptr{_SCIP_USEREXPRDATA}, (Ptr{_SCIP_EXPRGRAPHNODE},), node)
_SCIPexprgraphHasNodeUserEstimator(node) = @scip_ccall("SCIPexprgraphHasNodeUserEstimator", 
    _SCIP_Bool, (Ptr{_SCIP_EXPRGRAPHNODE},), node)
...
_SCIPexprgraphTightenNodeBounds(exprgraph, node, nodebounds, minstrength, infinity, cutoff) = @scip_ccall("SCIPexprgraphTightenNodeBounds", 
    Void, (Ptr{_SCIP_EXPRGRAPH}, Ptr{_SCIP_EXPRGRAPHNODE}, _SCIP_INTERVAL, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Bool},), exprgraph, node, nodebounds, minstrength, infinity, cutoff)
...
_SCIPfopen(path, mode) = @scip_ccall("SCIPfopen", 
    Ptr{_SCIP_FILE}, (String, String,), path, mode)
_SCIPfdopen(fildes, mode) = @scip_ccall("SCIPfdopen", 
    Ptr{_SCIP_FILE}, (Int, String,), fildes, mode)
...
_SCIPheurGetTime(heur) = @scip_ccall("SCIPheurGetTime", 
    _SCIP_Real, (Ptr{_SCIP_HEUR},), heur)
_SCIPheurGetDivesets(heur) = @scip_ccall("SCIPheurGetDivesets", 
    Ptr{Ptr{_SCIP_DIVESET}}, (Ptr{_SCIP_HEUR},), heur)
_SCIPheurGetNDivesets(heur) = @scip_ccall("SCIPheurGetNDivesets", 
    Int, (Ptr{_SCIP_HEUR},), heur)
_SCIPdivesetGetHeur(diveset) = @scip_ccall("SCIPdivesetGetHeur", 
    Ptr{_SCIP_HEUR}, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetWorkSolution(diveset) = @scip_ccall("SCIPdivesetGetWorkSolution", 
    Ptr{_SCIP_SOL}, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetSetWorkSolution(diveset, sol) = @scip_ccall("SCIPdivesetSetWorkSolution", 
    Void, (Ptr{_SCIP_DIVESET}, Ptr{_SCIP_SOL},), diveset, sol)
_SCIPdivesetGetName(diveset) = @scip_ccall("SCIPdivesetGetName", 
    String, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMinRelDepth(diveset) = @scip_ccall("SCIPdivesetGetMinRelDepth", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMaxRelDepth(diveset) = @scip_ccall("SCIPdivesetGetMaxRelDepth", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetSolSuccess(diveset) = @scip_ccall("SCIPdivesetGetSolSuccess", 
    Int64, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetNCalls(diveset) = @scip_ccall("SCIPdivesetGetNCalls", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetNSolutionCalls(diveset) = @scip_ccall("SCIPdivesetGetNSolutionCalls", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMinDepth(diveset) = @scip_ccall("SCIPdivesetGetMinDepth", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMaxDepth(diveset) = @scip_ccall("SCIPdivesetGetMaxDepth", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetAvgDepth(diveset) = @scip_ccall("SCIPdivesetGetAvgDepth", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMinSolutionDepth(diveset) = @scip_ccall("SCIPdivesetGetMinSolutionDepth", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMaxSolutionDepth(diveset) = @scip_ccall("SCIPdivesetGetMaxSolutionDepth", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetAvgSolutionDepth(diveset) = @scip_ccall("SCIPdivesetGetAvgSolutionDepth", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetNLPIterations(diveset) = @scip_ccall("SCIPdivesetGetNLPIterations", 
    Int64, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetNProbingNodes(diveset) = @scip_ccall("SCIPdivesetGetNProbingNodes", 
    Int64, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetNBacktracks(diveset) = @scip_ccall("SCIPdivesetGetNBacktracks", 
    Int64, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMaxLPIterQuot(diveset) = @scip_ccall("SCIPdivesetGetMaxLPIterQuot", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetMaxLPIterOffset(diveset) = @scip_ccall("SCIPdivesetGetMaxLPIterOffset", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetUbQuotNoSol(diveset) = @scip_ccall("SCIPdivesetGetUbQuotNoSol", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetAvgQuotNoSol(diveset) = @scip_ccall("SCIPdivesetGetAvgQuotNoSol", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetUbQuot(diveset) = @scip_ccall("SCIPdivesetGetUbQuot", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetAvgQuot(diveset) = @scip_ccall("SCIPdivesetGetAvgQuot", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetUseBacktrack(diveset) = @scip_ccall("SCIPdivesetUseBacktrack", 
    _SCIP_Bool, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetLPSolveFreq(diveset) = @scip_ccall("SCIPdivesetGetLPSolveFreq", 
    Int, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetGetLPResolveDomChgQuot(diveset) = @scip_ccall("SCIPdivesetGetLPResolveDomChgQuot", 
    _SCIP_Real, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetUseOnlyLPBranchcands(diveset) = @scip_ccall("SCIPdivesetUseOnlyLPBranchcands", 
    _SCIP_Bool, (Ptr{_SCIP_DIVESET},), diveset)
_SCIPdivesetSupportsType(diveset, divetype) = @scip_ccall("SCIPdivesetSupportsType", 
    _SCIP_Bool, (Ptr{_SCIP_DIVESET}, _SCIP_DIVETYPE,), diveset, divetype)
...
_SCIPcliqueGetId(clique) = @scip_ccall("SCIPcliqueGetId", 
    Int, (Ptr{_SCIP_CLIQUE},), clique)
_SCIPcliqueIsCleanedUp(clique) = @scip_ccall("SCIPcliqueIsCleanedUp", 
    _SCIP_Bool, (Ptr{_SCIP_CLIQUE},), clique)
_SCIPcliqueIsEquation(clique) = @scip_ccall("SCIPcliqueIsEquation", 
    _SCIP_Bool, (Ptr{_SCIP_CLIQUE},), clique)
...
_SCIProwIsInLP(row) = @scip_ccall("SCIProwIsInLP", 
    _SCIP_Bool, (Ptr{_SCIP_ROW},), row)
_SCIProwGetActiveLPCount(row) = @scip_ccall("SCIProwGetActiveLPCount", 
    Int64, (Ptr{_SCIP_ROW},), row)
_SCIProwGetNLPsAfterCreation(row) = @scip_ccall("SCIProwGetNLPsAfterCreation", 
    Int64, (Ptr{_SCIP_ROW},), row)
_SCIProwChgRank(row, rank) = @scip_ccall("SCIProwChgRank", 
    Void, (Ptr{_SCIP_ROW}, Int,), row, rank)
_SCIPmatrixGetColValPtr(matrix, col) = @scip_ccall("SCIPmatrixGetColValPtr", 
    Ptr{_SCIP_Real}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColIdxPtr(matrix, col) = @scip_ccall("SCIPmatrixGetColIdxPtr", 
    Ptr{Int}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColNNonzs(matrix, col) = @scip_ccall("SCIPmatrixGetColNNonzs", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetNColumns(matrix) = @scip_ccall("SCIPmatrixGetNColumns", 
    Int, (Ptr{_SCIPMILPMATRIX},), matrix)
_SCIPmatrixGetColUb(matrix, col) = @scip_ccall("SCIPmatrixGetColUb", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColLb(matrix, col) = @scip_ccall("SCIPmatrixGetColLb", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColNUplocks(matrix, col) = @scip_ccall("SCIPmatrixGetColNUplocks", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColNDownlocks(matrix, col) = @scip_ccall("SCIPmatrixGetColNDownlocks", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetVar(matrix, col) = @scip_ccall("SCIPmatrixGetVar", 
    Ptr{_SCIP_VAR}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetColName(matrix, col) = @scip_ccall("SCIPmatrixGetColName", 
    String, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixGetRowValPtr(matrix, row) = @scip_ccall("SCIPmatrixGetRowValPtr", 
    Ptr{_SCIP_Real}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowIdxPtr(matrix, row) = @scip_ccall("SCIPmatrixGetRowIdxPtr", 
    Ptr{Int}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowNNonzs(matrix, row) = @scip_ccall("SCIPmatrixGetRowNNonzs", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowName(matrix, row) = @scip_ccall("SCIPmatrixGetRowName", 
    String, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetNRows(matrix) = @scip_ccall("SCIPmatrixGetNRows", 
    Int, (Ptr{_SCIPMILPMATRIX},), matrix)
_SCIPmatrixGetRowLhs(matrix, row) = @scip_ccall("SCIPmatrixGetRowLhs", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowRhs(matrix, row) = @scip_ccall("SCIPmatrixGetRowRhs", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixIsRowRhsInfinity(matrix, row) = @scip_ccall("SCIPmatrixIsRowRhsInfinity", 
    _SCIP_Bool, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetNNonzs(matrix) = @scip_ccall("SCIPmatrixGetNNonzs", 
    Int, (Ptr{_SCIPMILPMATRIX},), matrix)
_SCIPmatrixGetRowMinActivity(matrix, row) = @scip_ccall("SCIPmatrixGetRowMinActivity", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowMaxActivity(matrix, row) = @scip_ccall("SCIPmatrixGetRowMaxActivity", 
    _SCIP_Real, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowNMinActNegInf(matrix, row) = @scip_ccall("SCIPmatrixGetRowNMinActNegInf", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowNMinActPosInf(matrix, row) = @scip_ccall("SCIPmatrixGetRowNMinActPosInf", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowNMaxActNegInf(matrix, row) = @scip_ccall("SCIPmatrixGetRowNMaxActNegInf", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetRowNMaxActPosInf(matrix, row) = @scip_ccall("SCIPmatrixGetRowNMaxActPosInf", 
    Int, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixGetCons(matrix, row) = @scip_ccall("SCIPmatrixGetCons", 
    Ptr{_SCIP_CONS}, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, row)
_SCIPmatrixUplockConflict(matrix, col) = @scip_ccall("SCIPmatrixUplockConflict", 
    _SCIP_Bool, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixDownlockConflict(matrix, col) = @scip_ccall("SCIPmatrixDownlockConflict", 
    _SCIP_Bool, (Ptr{_SCIPMILPMATRIX}, Int,), matrix, col)
_SCIPmatrixFree(scip, matrix) = @scip_ccall("SCIPmatrixFree", 
    Void, (Ptr{_SCIP}, Ptr{Ptr{_SCIPMILPMATRIX}},), scip, matrix)
_SCIPmatrixPrintRow(scip, matrix, row) = @scip_ccall("SCIPmatrixPrintRow", 
    Void, (Ptr{_SCIP}, Ptr{_SCIPMILPMATRIX}, Int,), scip, matrix, row)
...
_SCIPmessagehdlrSetLogfile(messagehdlr, filename) = @scip_ccall("SCIPmessagehdlrSetLogfile", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, String,), messagehdlr, filename)
...
_SCIPmessageVPrintInfo(messagehdlr, formatstr, ap) = @scip_ccall("SCIPmessageVPrintInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, String, va_list,), messagehdlr, formatstr, ap)
_SCIPmessageVFPrintInfo(messagehdlr, file, formatstr, ap) = @scip_ccall("SCIPmessageVFPrintInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, Ptr{FILE}, String, va_list,), messagehdlr, file, formatstr, ap)
...
_SCIPmessageVPrintVerbInfo(messagehdlr, verblevel, msgverblevel, formatstr, ap) = @scip_ccall("SCIPmessageVPrintVerbInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, _SCIP_VERBLEVEL, _SCIP_VERBLEVEL, String, va_list,), messagehdlr, verblevel, msgverblevel, formatstr, ap)
_SCIPmessageVFPrintVerbInfo(messagehdlr, verblevel, msgverblevel, file, formatstr, ap) = @scip_ccall("SCIPmessageVFPrintVerbInfo", 
    Void, (Ptr{_SCIP_MESSAGEHDLR}, _SCIP_VERBLEVEL, _SCIP_VERBLEVEL, Ptr{FILE}, String, va_list,), messagehdlr, verblevel, msgverblevel, file, formatstr, ap)
_SCIPmessagePrintErrorHeader(sourcefile, sourceline) = @scip_ccall("SCIPmessagePrintErrorHeader", 
    Void, (String, Int,), sourcefile, sourceline)
_SCIPmessageVPrintError(formatstr, ap) = @scip_ccall("SCIPmessageVPrintError", 
    Void, (String, va_list,), formatstr, ap)
...
_SCIPstudentTGetCriticalValue(clevel, df) = @scip_ccall("SCIPstudentTGetCriticalValue", 
    _SCIP_Real, (_SCIP_CONFIDENCELEVEL, Int,), clevel, df)
_SCIPcomputeTwoSampleTTestValue(meanx, meany, variancex, variancey, countx, county) = @scip_ccall("SCIPcomputeTwoSampleTTestValue", 
    _SCIP_Real, (_SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real,), meanx, meany, variancex, variancey, countx, county)
_SCIPerf(x) = @scip_ccall("SCIPerf", 
    _SCIP_Real, (_SCIP_Real,), x)
_SCIPnormalGetCriticalValue(clevel) = @scip_ccall("SCIPnormalGetCriticalValue", 
    _SCIP_Real, (_SCIP_CONFIDENCELEVEL,), clevel)
_SCIPnormalCDF(mean, variance, value) = @scip_ccall("SCIPnormalCDF", 
    _SCIP_Real, (_SCIP_Real, _SCIP_Real, _SCIP_Real,), mean, variance, value)
_SCIPgmlWriteNode(file, id, label, nodetype, fillcolor, bordercolor) = @scip_ccall("SCIPgmlWriteNode", 
    Void, (Ptr{FILE}, Uint, String, String, String, String,), file, id, label, nodetype, fillcolor, bordercolor)
_SCIPgmlWriteNodeWeight(file, id, label, nodetype, fillcolor, bordercolor, weight) = @scip_ccall("SCIPgmlWriteNodeWeight", 
    Void, (Ptr{FILE}, Uint, String, String, String, String, _SCIP_Real,), file, id, label, nodetype, fillcolor, bordercolor, weight)
_SCIPgmlWriteEdge(file, source, target, label, color) = @scip_ccall("SCIPgmlWriteEdge", 
    Void, (Ptr{FILE}, Uint, Uint, String, String,), file, source, target, label, color)
...
_SCIPdigraphGetSuccessorsData(digraph, node) = @scip_ccall("SCIPdigraphGetSuccessorsData", 
...
_SCIPsortRealIntInt(realarray, intarray1, intarray2, len) = @scip_ccall("SCIPsortRealIntInt", 
    Void, (Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int}, Int,), realarray, intarray1, intarray2, len)
...
_SCIPsortRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, len) = @scip_ccall("SCIPsortRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int,), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, len)
...
_SCIPsortIntIntIntReal(intarray1, intarray2, intarray3, realarray, len) = @scip_ccall("SCIPsortIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int,), intarray1, intarray2, intarray3, realarray, len)
...
_SCIPsortDownRealRealRealBoolPtr(realarray1, realarray2, realarray3, boolarray, ptrarray, len) = @scip_ccall("SCIPsortDownRealRealRealBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int,), realarray1, realarray2, realarray3, boolarray, ptrarray, len)
_SCIPsortDownRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, len) = @scip_ccall("SCIPsortDownRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int,), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, len)
...
_SCIPsortDownIntIntIntPtr(intarray1, intarray2, intarray3, ptrarray, len) = @scip_ccall("SCIPsortDownIntIntIntPtr", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{Ptr{Void}}, Int,), intarray1, intarray2, intarray3, ptrarray, len)
_SCIPsortDownIntIntIntReal(intarray1, intarray2, intarray3, realarray, len) = @scip_ccall("SCIPsortDownIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int,), intarray1, intarray2, intarray3, realarray, len)
...
_SCIPsortDownIntPtrIntIntBoolBool(intarray1, ptrarray, intarray2, intarray3, boolarray1, boolarray2, len) = @scip_ccall("SCIPsortDownIntPtrIntIntBoolBool", 
    Void, (Ptr{Int}, Ptr{Ptr{Void}}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Int,), intarray1, ptrarray, intarray2, intarray3, boolarray1, boolarray2, len)
_SCIPsortedvecInsertRealIntInt(realarray, intarray1, intarray2, keyval, field2val, field3val, len, pos) = @scip_ccall("SCIPsortedvecInsertRealIntInt", 
    Void, (Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int}, _SCIP_Real, Int, Int, Ptr{Int}, Ptr{Int},), realarray, intarray1, intarray2, keyval, field2val, field3val, len, pos)
...
_SCIPsortedvecInsertRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, keyval, field1val, field2val, field3val, field4val, field5val, len, pos) = @scip_ccall("SCIPsortedvecInsertRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, Ptr{Void}, Ptr{Int}, Ptr{Int},), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, keyval, field1val, field2val, field3val, field4val, field5val, len, pos)
...
_SCIPsortedvecInsertIntIntIntReal(intarray1, intarray2, intarray3, realarray, keyval, field1val, field2val, field3val, len, pos) = @scip_ccall("SCIPsortedvecInsertIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int, Int, Int, _SCIP_Real, Ptr{Int}, Ptr{Int},), intarray1, intarray2, intarray3, realarray, keyval, field1val, field2val, field3val, len, pos)
...
_SCIPsortedvecInsertDownRealInt(realarray, intarray, keyval, field1val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownRealInt", 
    Void, (Ptr{_SCIP_Real}, Ptr{Int}, _SCIP_Real, Int, Ptr{Int}, Ptr{Int},), realarray, intarray, keyval, field1val, len, pos)
_SCIPsortedvecInsertDownRealIntInt(realarray, intarray1, intarray2, keyval, field1val, field2val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownRealIntInt", 
    Void, (Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int}, _SCIP_Real, Int, Int, Ptr{Int}, Ptr{Int},), realarray, intarray1, intarray2, keyval, field1val, field2val, len, pos)
...
_SCIPsortedvecInsertDownRealRealRealBoolPtr(realarray1, realarray2, realarray3, boolarray, ptrarray, keyval, field1val, field2val, field3val, field4val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownRealRealRealBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, Ptr{Void}, Ptr{Int}, Ptr{Int},), realarray1, realarray2, realarray3, boolarray, ptrarray, keyval, field1val, field2val, field3val, field4val, len, pos)
_SCIPsortedvecInsertDownRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, keyval, field1val, field2val, field3val, field4val, field5val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, Ptr{Void}, Ptr{Int}, Ptr{Int},), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, keyval, field1val, field2val, field3val, field4val, field5val, len, pos)
...
_SCIPsortedvecInsertDownIntIntIntPtr(intarray1, intarray2, intarray3, ptrarray, keyval, field1val, field2val, field3val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownIntIntIntPtr", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{Ptr{Void}}, Int, Int, Int, Ptr{Void}, Ptr{Int}, Ptr{Int},), intarray1, intarray2, intarray3, ptrarray, keyval, field1val, field2val, field3val, len, pos)
_SCIPsortedvecInsertDownIntIntIntReal(intarray1, intarray2, intarray3, realarray, keyval, field1val, field2val, field3val, len, pos) = @scip_ccall("SCIPsortedvecInsertDownIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int, Int, Int, _SCIP_Real, Ptr{Int}, Ptr{Int},), intarray1, intarray2, intarray3, realarray, keyval, field1val, field2val, field3val, len, pos)
...
_SCIPsortedvecDelPosRealIntInt(realarray, intarray1, intarray2, pos, len) = @scip_ccall("SCIPsortedvecDelPosRealIntInt", 
    Void, (Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int}, Int, Ptr{Int},), realarray, intarray1, intarray2, pos, len)
...
_SCIPsortedvecDelPosRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int, Ptr{Int},), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, pos, len)
...
_SCIPsortedvecDelPosIntIntIntReal(intarray1, intarray2, intarray3, realarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int, Ptr{Int},), intarray1, intarray2, intarray3, realarray, pos, len)
...
_SCIPsortedvecDelPosDownRealRealRealBoolPtr(realarray1, realarray2, realarray3, boolarray, ptrarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosDownRealRealRealBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int, Ptr{Int},), realarray1, realarray2, realarray3, boolarray, ptrarray, pos, len)
_SCIPsortedvecDelPosDownRealRealRealBoolBoolPtr(realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosDownRealRealRealBoolBoolPtr", 
    Void, (Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Ptr{Void}}, Int, Ptr{Int},), realarray1, realarray2, realarray3, boolarray1, boolarray2, ptrarray, pos, len)
...
_SCIPsortedvecDelPosDownIntIntIntPtr(intarray1, intarray2, intarray3, ptrarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosDownIntIntIntPtr", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{Ptr{Void}}, Int, Ptr{Int},), intarray1, intarray2, intarray3, ptrarray, pos, len)
_SCIPsortedvecDelPosDownIntIntIntReal(intarray1, intarray2, intarray3, realarray, pos, len) = @scip_ccall("SCIPsortedvecDelPosDownIntIntIntReal", 
    Void, (Ptr{Int}, Ptr{Int}, Ptr{Int}, Ptr{_SCIP_Real}, Int, Ptr{Int},), intarray1, intarray2, intarray3, realarray, pos, len)
...
_SCIPnodeselGetName(nodesel) = @scip_ccall("SCIPnodeselGetName", 
    String, (Ptr{_SCIP_NODESEL},), nodesel)
...
_SCIPpresolGetName(presol) = @scip_ccall("SCIPpresolGetName", 
    String, (Ptr{_SCIP_PRESOL},), presol)
...
_SCIPpresolGetMaxrounds(presol) = @scip_ccall("SCIPpresolGetMaxrounds", 
    Int, (Ptr{_SCIP_PRESOL},), presol)
_SCIPpresolGetTiming(presol) = @scip_ccall("SCIPpresolGetTiming", 
    _SCIP_PRESOLTIMING, (Ptr{_SCIP_PRESOL},), presol)
_SCIPpresolSetTiming(presol, timing) = @scip_ccall("SCIPpresolSetTiming", 
    Void, (Ptr{_SCIP_PRESOL}, _SCIP_PRESOLTIMING,), presol, timing)
...
_SCIPpricerGetName(pricer) = @scip_ccall("SCIPpricerGetName", 
    String, (Ptr{_SCIP_PRICER},), pricer)
...
_SCIPpropDoesPresolve(prop) = @scip_ccall("SCIPpropDoesPresolve", 
    _SCIP_Bool, (Ptr{_SCIP_PROP},), prop)
_SCIPpropGetPresolTiming(prop) = @scip_ccall("SCIPpropGetPresolTiming", 
    _SCIP_PRESOLTIMING, (Ptr{_SCIP_PROP},), prop)
_SCIPpropSetPresolTiming(prop, presoltiming) = @scip_ccall("SCIPpropSetPresolTiming", 
    Void, (Ptr{_SCIP_PROP}, _SCIP_PRESOLTIMING,), prop, presoltiming)
...
_SCIPreaderGetName(reader) = @scip_ccall("SCIPreaderGetName", 
    String, (Ptr{_SCIP_READER},), reader)
...
_SCIPreoptnodeGetNVars(reoptnode) = @scip_ccall("SCIPreoptnodeGetNVars", 
    Int, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetNConss(reoptnode) = @scip_ccall("SCIPreoptnodeGetNConss", 
    Int, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetNDualBoundChgs(reoptnode) = @scip_ccall("SCIPreoptnodeGetNDualBoundChgs", 
    Int, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetNChildren(reoptnode) = @scip_ccall("SCIPreoptnodeGetNChildren", 
    Int, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetLowerbound(reoptnode) = @scip_ccall("SCIPreoptnodeGetLowerbound", 
    _SCIP_Real, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetType(reoptnode) = @scip_ccall("SCIPreoptnodeGetType", 
    _SCIP_REOPTTYPE, (Ptr{_SCIP_REOPTNODE},), reoptnode)
_SCIPreoptnodeGetSplitCons(reoptnode, vars, vals, constype, conssize, nvars) = @scip_ccall("SCIPreoptnodeGetSplitCons", 
    Void, (Ptr{_SCIP_REOPTNODE}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{REOPT_CONSTYPE}, Int, Ptr{Int},), reoptnode, vars, vals, constype, conssize, nvars)
_SCIPreoptnodeGetConss(reoptnode, vars, vals, mem, nconss, nvars) = @scip_ccall("SCIPreoptnodeGetConss", 
    Void, (Ptr{_SCIP_REOPTNODE}, Ptr{Ptr{Ptr{_SCIP_VAR}}}, Ptr{Ptr{_SCIP_Real}}, Int, Ptr{Int}, Ptr{Int},), reoptnode, vars, vals, mem, nconss, nvars)
_SCIPreoptnodeSetParentID(reoptnode, parentid) = @scip_ccall("SCIPreoptnodeSetParentID", 
    Void, (Ptr{_SCIP_REOPTNODE}, Uint,), reoptnode, parentid)
_SCIPreoptGetNRestartsGlobal(reopt) = @scip_ccall("SCIPreoptGetNRestartsGlobal", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNRestartsLocal(reopt) = @scip_ccall("SCIPreoptGetNRestartsLocal", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNTotalRestartsLocal(reopt) = @scip_ccall("SCIPreoptGetNTotalRestartsLocal", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetFirstRestarts(reopt) = @scip_ccall("SCIPreoptGetFirstRestarts", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetLastRestarts(reopt) = @scip_ccall("SCIPreoptGetLastRestarts", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNFeasNodes(reopt) = @scip_ccall("SCIPreoptGetNFeasNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNTotalFeasNodes(reopt) = @scip_ccall("SCIPreoptGetNTotalFeasNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNPrunedNodes(reopt) = @scip_ccall("SCIPreoptGetNPrunedNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNTotalPrunedNodes(reopt) = @scip_ccall("SCIPreoptGetNTotalPrunedNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNCutoffReoptnodes(reopt) = @scip_ccall("SCIPreoptGetNCutoffReoptnodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNTotalCutoffReoptnodes(reopt) = @scip_ccall("SCIPreoptGetNTotalCutoffReoptnodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNInfNodes(reopt) = @scip_ccall("SCIPreoptGetNInfNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNTotalInfNodes(reopt) = @scip_ccall("SCIPreoptGetNTotalInfNodes", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
_SCIPreoptGetNInfSubtrees(reopt) = @scip_ccall("SCIPreoptGetNInfSubtrees", 
    Int, (Ptr{_SCIP_REOPT},), reopt)
...
_SCIPnodeGetAncestorBranchings(node, branchvars, branchbounds, boundtypes, nbranchvars, branchvarssize) = @scip_ccall("SCIPnodeGetAncestorBranchings", 
    Void, (Ptr{_SCIP_NODE}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_BOUNDTYPE}, Ptr{Int}, Int,), node, branchvars, branchbounds, boundtypes, nbranchvars, branchvarssize)
_SCIPnodeGetAncestorBranchingsPart(node, parent, branchvars, branchbounds, boundtypes, nbranchvars, branchvarssize) = @scip_ccall("SCIPnodeGetAncestorBranchingsPart", 
    Void, (Ptr{_SCIP_NODE}, Ptr{_SCIP_NODE}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_BOUNDTYPE}, Ptr{Int}, Int,), node, parent, branchvars, branchbounds, boundtypes, nbranchvars, branchvarssize)
...
_SCIPnodeGetEstimate(node) = @scip_ccall("SCIPnodeGetEstimate", 
    _SCIP_Real, (Ptr{_SCIP_NODE},), node)
_SCIPnodeGetReopttype(node) = @scip_ccall("SCIPnodeGetReopttype", 
    _SCIP_REOPTTYPE, (Ptr{_SCIP_NODE},), node)
_SCIPnodeGetReoptID(node) = @scip_ccall("SCIPnodeGetReoptID", 
    Uint, (Ptr{_SCIP_NODE},), node)
_SCIPnodeSetReopttype(node, typeVar) = @scip_ccall("SCIPnodeSetReopttype", 
    Void, (Ptr{_SCIP_NODE}, _SCIP_REOPTTYPE,), node, typeVar)
_SCIPnodeSetReoptID(node, id) = @scip_ccall("SCIPnodeSetReoptID", 
    Void, (Ptr{_SCIP_NODE}, Uint,), node, id)
_SCIPnodeGetNDomchg(node, nbranchings, nconsprop, nprop) = @scip_ccall("SCIPnodeGetNDomchg", 
    Void, (Ptr{_SCIP_NODE}, Ptr{Int}, Ptr{Int}, Ptr{Int},), node, nbranchings, nconsprop, nprop)
...
_SCIPvarGetObj(var) = @scip_ccall("SCIPvarGetObj", 
    _SCIP_Real, (Ptr{_SCIP_VAR},), var)
_SCIPvarGetUnchangedObj(var) = @scip_ccall("SCIPvarGetUnchangedObj", 
    _SCIP_Real, (Ptr{_SCIP_VAR},), var)
...
_SCIPsetMessagehdlrLogfile(scip, filename) = @scip_ccall("SCIPsetMessagehdlrLogfile", 
    Void, (Ptr{_SCIP}, String,), scip, filename)
...
_SCIPisParamFixed(scip, name) = @scip_ccall("SCIPisParamFixed", 
    _SCIP_Bool, (Ptr{_SCIP}, String,), scip, name)
_SCIPgetParam(scip, name) = @scip_ccall("SCIPgetParam", 
    Ptr{_SCIP_PARAM}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindReader(scip, name) = @scip_ccall("SCIPfindReader", 
    Ptr{_SCIP_READER}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindPricer(scip, name) = @scip_ccall("SCIPfindPricer", 
    Ptr{_SCIP_PRICER}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindConshdlr(scip, name) = @scip_ccall("SCIPfindConshdlr", 
    Ptr{_SCIP_CONSHDLR}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindConflicthdlr(scip, name) = @scip_ccall("SCIPfindConflicthdlr", 
    Ptr{_SCIP_CONFLICTHDLR}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindPresol(scip, name) = @scip_ccall("SCIPfindPresol", 
    Ptr{_SCIP_PRESOL}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindRelax(scip, name) = @scip_ccall("SCIPfindRelax", 
    Ptr{_SCIP_RELAX}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindSepa(scip, name) = @scip_ccall("SCIPfindSepa", 
    Ptr{_SCIP_SEPA}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindProp(scip, name) = @scip_ccall("SCIPfindProp", 
    Ptr{_SCIP_PROP}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindHeur(scip, name) = @scip_ccall("SCIPfindHeur", 
    Ptr{_SCIP_HEUR}, (Ptr{_SCIP}, String,), scip, name)
_SCIPgetHeurs(scip) = @scip_ccall("SCIPgetHeurs", 
    Ptr{Ptr{_SCIP_HEUR}}, (Ptr{_SCIP},), scip)
_SCIPgetNHeurs(scip) = @scip_ccall("SCIPgetNHeurs", 
    Int, (Ptr{_SCIP},), scip)
_SCIPfindCompr(scip, name) = @scip_ccall("SCIPfindCompr", 
    Ptr{_SCIP_COMPR}, (Ptr{_SCIP}, String,), scip, name)
_SCIPgetComprs(scip) = @scip_ccall("SCIPgetComprs", 
    Ptr{Ptr{_SCIP_COMPR}}, (Ptr{_SCIP},), scip)
_SCIPgetNCompr(scip) = @scip_ccall("SCIPgetNCompr", 
    Int, (Ptr{_SCIP},), scip)
_SCIPfindEventhdlr(scip, name) = @scip_ccall("SCIPfindEventhdlr", 
    Ptr{_SCIP_EVENTHDLR}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindNodesel(scip, name) = @scip_ccall("SCIPfindNodesel", 
    Ptr{_SCIP_NODESEL}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindBranchrule(scip, name) = @scip_ccall("SCIPfindBranchrule", 
    Ptr{_SCIP_BRANCHRULE}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindDisp(scip, name) = @scip_ccall("SCIPfindDisp", 
    Ptr{_SCIP_DISP}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPfindNlpi(scip, name) = @scip_ccall("SCIPfindNlpi", 
    Ptr{_SCIP_NLPI}, (Ptr{_SCIP}, String,), scip, name)
...
_SCIPgetNodeLowerbound(scip, node) = @scip_ccall("SCIPgetNodeLowerbound", 
    _SCIP_Real, (Ptr{_SCIP}, Ptr{_SCIP_NODE},), scip, node)
_SCIPisReoptEnabled(scip) = @scip_ccall("SCIPisReoptEnabled", 
    _SCIP_Bool, (Ptr{_SCIP},), scip)
_SCIPresetReoptSolMarks(scip) = @scip_ccall("SCIPresetReoptSolMarks", 
    Void, (Ptr{_SCIP},), scip)
_SCIPgetReoptLastOptSol(scip) = @scip_ccall("SCIPgetReoptLastOptSol", 
...
_SCIPallowDualReds(scip) = @scip_ccall("SCIPallowDualReds", 
    _SCIP_Bool, (Ptr{_SCIP},), scip)
_SCIPallowObjProp(scip) = @scip_ccall("SCIPallowObjProp", 
    _SCIP_Bool, (Ptr{_SCIP},), scip)
...
_SCIPgetVarPseudocostCountCurrentRun(scip, var, dir) = @scip_ccall("SCIPgetVarPseudocostCountCurrentRun", 
    _SCIP_Real, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_BRANCHDIR,), scip, var, dir)
_SCIPgetVarPseudocostVariance(scip, var, dir, onlycurrentrun) = @scip_ccall("SCIPgetVarPseudocostVariance", 
    _SCIP_Real, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_BRANCHDIR, _SCIP_Bool,), scip, var, dir, onlycurrentrun)
_SCIPcalculatePscostConfidenceBound(scip, var, dir, onlycurrentrun, clevel) = @scip_ccall("SCIPcalculatePscostConfidenceBound", 
    _SCIP_Real, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_BRANCHDIR, _SCIP_Bool, _SCIP_CONFIDENCELEVEL,), scip, var, dir, onlycurrentrun, clevel)
_SCIPsignificantVarPscostDifference(scip, varx, fracx, vary, fracy, dir, clevel, onesided) = @scip_ccall("SCIPsignificantVarPscostDifference", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_BRANCHDIR, _SCIP_CONFIDENCELEVEL, _SCIP_Bool,), scip, varx, fracx, vary, fracy, dir, clevel, onesided)
_SCIPpscostThresholdProbabilityTest(scip, var, frac, threshold, dir, clevel) = @scip_ccall("SCIPpscostThresholdProbabilityTest", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_BRANCHDIR, _SCIP_CONFIDENCELEVEL,), scip, var, frac, threshold, dir, clevel)
_SCIPisVarPscostRelerrorReliable(scip, var, threshold, clevel) = @scip_ccall("SCIPisVarPscostRelerrorReliable", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_CONFIDENCELEVEL,), scip, var, threshold, clevel)
...
_SCIPgetProbingDepth(scip) = @scip_ccall("SCIPgetProbingDepth", 
    Int, (Ptr{_SCIP},), scip)
_SCIPgetVarObjProbing(scip, var) = @scip_ccall("SCIPgetVarObjProbing", 
    _SCIP_Real, (Ptr{_SCIP}, Ptr{_SCIP_VAR},), scip, var)
_SCIPupdateDivesetLPStats(scip, diveset, niterstoadd) = @scip_ccall("SCIPupdateDivesetLPStats", 
    Void, (Ptr{_SCIP}, Ptr{_SCIP_DIVESET}, Int64,), scip, diveset, niterstoadd)
_SCIPupdateDivesetStats(scip, diveset, nprobingnodes, nbacktracks, nsolsfound, nbestsolsfound, leavewassol) = @scip_ccall("SCIPupdateDivesetStats", 
    Void, (Ptr{_SCIP}, Ptr{_SCIP_DIVESET}, Int, Int, Int64, Int64, _SCIP_Bool,), scip, diveset, nprobingnodes, nbacktracks, nsolsfound, nbestsolsfound, leavewassol)
_SCIPgetDiveBoundChangeData(scip, variables, directions, values, ndivebdchgs, preferred) = @scip_ccall("SCIPgetDiveBoundChangeData", 
    Void, (Ptr{_SCIP}, Ptr{Ptr{Ptr{_SCIP_VAR}}}, Ptr{Ptr{_SCIP_BRANCHDIR}}, Ptr{Ptr{_SCIP_Real}}, Ptr{Int}, _SCIP_Bool,), scip, variables, directions, values, ndivebdchgs, preferred)
_SCIPclearDiveBoundChanges(scip) = @scip_ccall("SCIPclearDiveBoundChanges", 
    Void, (Ptr{_SCIP},), scip)
...
_SCIPgetRootNode(scip) = @scip_ccall("SCIPgetRootNode", 
    Ptr{_SCIP_NODE}, (Ptr{_SCIP},), scip)
_SCIPgetEffectiveRootDepth(scip) = @scip_ccall("SCIPgetEffectiveRootDepth", 
    Int, (Ptr{_SCIP},), scip)
...
_SCIPgetRepropdepth(scip) = @scip_ccall("SCIPgetRepropdepth", 
    Int, (Ptr{_SCIP},), scip)
_SCIPsetFocusnodeLP(scip, solvelp) = @scip_ccall("SCIPsetFocusnodeLP", 
    Void, (Ptr{_SCIP}, _SCIP_Bool,), scip, solvelp)
_SCIPgetNReoptnodes(scip, node) = @scip_ccall("SCIPgetNReoptnodes", 
    Int, (Ptr{_SCIP}, Ptr{_SCIP_NODE},), scip, node)
_SCIPgetNReoptLeaves(scip, node) = @scip_ccall("SCIPgetNReoptLeaves", 
    Int, (Ptr{_SCIP}, Ptr{_SCIP_NODE},), scip, node)
_SCIPgetReoptnode(scip, id) = @scip_ccall("SCIPgetReoptnode", 
    Ptr{_SCIP_REOPTNODE}, (Ptr{_SCIP}, Uint,), scip, id)
_SCIPgetReoptnodePath(scip, reoptnode, vars, vals, boundtypes, mem, nvars, nafterdualvars) = @scip_ccall("SCIPgetReoptnodePath", 
    Void, (Ptr{_SCIP}, Ptr{_SCIP_REOPTNODE}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_BOUNDTYPE}, Int, Ptr{Int}, Ptr{Int},), scip, reoptnode, vars, vals, boundtypes, mem, nvars, nafterdualvars)
_SCIPreoptimizeNode(scip, node) = @scip_ccall("SCIPreoptimizeNode", 
    _SCIP_Bool, (Ptr{_SCIP}, Ptr{_SCIP_NODE},), scip, node)
_SCIPgetReoptSimilarity(scip, run1, run2) = @scip_ccall("SCIPgetReoptSimilarity", 
    _SCIP_Real, (Ptr{_SCIP}, Int, Int,), scip, run1, run2)
_SCIPgetVarCoefChg(scip, varidx, negated, entering, leaving) = @scip_ccall("SCIPgetVarCoefChg", 
    Void, (Ptr{_SCIP}, Int, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, varidx, negated, entering, leaving)
_SCIPgetNRuns(scip) = @scip_ccall("SCIPgetNRuns", 
    Int, (Ptr{_SCIP},), scip)
_SCIPgetNReoptRuns(scip) = @scip_ccall("SCIPgetNReoptRuns", 
    Int, (Ptr{_SCIP},), scip)
...
_SCIPbuffer(scip) = @scip_ccall("SCIPbuffer", 
    Ptr{BMS_BUFMEM}, (Ptr{_SCIP},), scip)
_SCIPcleanbuffer(scip) = @scip_ccall("SCIPcleanbuffer", 
    Ptr{BMS_BUFMEM}, (Ptr{_SCIP},), scip)
...
_SCIPcreateConsAbspower(scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsAbspower", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicAbspower(scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicAbspower", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs)
...
_SCIPcreateConsAnd(scip, cons, name, resvar, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsAnd", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, resvar, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicAnd(scip, cons, name, resvar, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicAnd", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, resvar, nvars, vars)
...
_SCIPcreateConsBivariate(scip, cons, name, f, convextype, z, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsBivariate", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_EXPRTREE}, _SCIP_BIVAR_CONVEXITY, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, f, convextype, z, zcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicBivariate(scip, cons, name, f, convextype, z, zcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicBivariate", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_EXPRTREE}, _SCIP_BIVAR_CONVEXITY, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, f, convextype, z, zcoef, lhs, rhs)
...
_SCIPcreateConsBounddisjunction(scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsBounddisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_BOUNDTYPE}, Ptr{_SCIP_Real}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicBounddisjunction(scip, cons, name, nvars, vars, boundtypes, bounds) = @scip_ccall_check("SCIPcreateConsBasicBounddisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_BOUNDTYPE}, Ptr{_SCIP_Real},), scip, cons, name, nvars, vars, boundtypes, bounds)
...
_SCIPcreateConsConjunction(scip, cons, name, nconss, conss, enforce, check, localVar, modifiable, dynamic) = @scip_ccall_check("SCIPcreateConsConjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_CONS}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nconss, conss, enforce, check, localVar, modifiable, dynamic)
_SCIPcreateConsBasicConjunction(scip, cons, name, nconss, conss) = @scip_ccall_check("SCIPcreateConsBasicConjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_CONS}},), scip, cons, name, nconss, conss)
...
_SCIPcreateConsBasicCumulative(scip, cons, name, nvars, vars, durations, demands, capacity) = @scip_ccall_check("SCIPcreateConsBasicCumulative", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int}, Ptr{Int}, Int,), scip, cons, name, nvars, vars, durations, demands, capacity)
...
_SCIPpropCumulativeCondition(scip, presoltiming, nvars, vars, durations, demands, capacity, hmin, hmax, cons, nchgbds, initialized, explanation, cutoff) = @scip_ccall_check("SCIPpropCumulativeCondition", 
    (Ptr{_SCIP}, _SCIP_PRESOLTIMING, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int}, Ptr{Int}, Int, Int, Int, Ptr{_SCIP_CONS}, Ptr{Int}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, presoltiming, nvars, vars, durations, demands, capacity, hmin, hmax, cons, nchgbds, initialized, explanation, cutoff)
...
_SCIPcreateConsDisjunction(scip, cons, name, nconss, conss, relaxcons, initial, enforce, check, localVar, modifiable, dynamic) = @scip_ccall_check("SCIPcreateConsDisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONS}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nconss, conss, relaxcons, initial, enforce, check, localVar, modifiable, dynamic)
_SCIPcreateConsBasicDisjunction(scip, cons, name, nconss, conss, relaxcons) = @scip_ccall_check("SCIPcreateConsBasicDisjunction", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONS},), scip, cons, name, nconss, conss, relaxcons)
...
_SCIPcreateConsIndicator(scip, cons, name, binvar, nvars, vars, vals, rhs, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsIndicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, nvars, vars, vals, rhs, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicIndicator(scip, cons, name, binvar, nvars, vars, vals, rhs) = @scip_ccall_check("SCIPcreateConsBasicIndicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real,), scip, cons, name, binvar, nvars, vars, vals, rhs)
_SCIPcreateConsIndicatorLinCons(scip, cons, name, binvar, lincons, slackvar, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsIndicatorLinCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, lincons, slackvar, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicIndicatorLinCons(scip, cons, name, binvar, lincons, slackvar) = @scip_ccall_check("SCIPcreateConsBasicIndicatorLinCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR},), scip, cons, name, binvar, lincons, slackvar)
...
_SCIPcreateConsKnapsack(scip, cons, name, nvars, vars, weights, capacity, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsKnapsack", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int64}, Int64, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, weights, capacity, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicKnapsack(scip, cons, name, nvars, vars, weights, capacity) = @scip_ccall_check("SCIPcreateConsBasicKnapsack", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int64}, Int64,), scip, cons, name, nvars, vars, weights, capacity)
...
_SCIPcreateConsLinear(scip, cons, name, nvars, vars, vals, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, vals, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicLinear(scip, cons, name, nvars, vars, vals, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nvars, vars, vals, lhs, rhs)
_SCIPcopyConsLinear(scip, cons, sourcescip, name, nvars, sourcevars, sourcecoefs, lhs, rhs, varmap, consmap, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, valid) = @scip_ccall_check("SCIPcopyConsLinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), scip, cons, sourcescip, name, nvars, sourcevars, sourcecoefs, lhs, rhs, varmap, consmap, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, valid)
_SCIPaddCoefLinear(scip, cons, var, val) = @scip_ccall_check("SCIPaddCoefLinear", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, cons, var, val)
_SCIPchgCoefLinear(scip, cons, var, val) = @scip_ccall_check("SCIPchgCoefLinear", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, cons, var, val)
_SCIPdelCoefLinear(scip, cons, var) = @scip_ccall_check("SCIPdelCoefLinear", 
...
_SCIPcreateConsLogicor(scip, cons, name, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsLogicor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicLogicor(scip, cons, name, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicLogicor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, nvars, vars)
...
_SCIPcreateConsNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsNonlinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_EXPRTREE}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicNonlinear", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_EXPRTREE}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nexprtrees, exprtrees, nonlincoefs, lhs, rhs)
_SCIPcreateConsNonlinear2(scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsNonlinear2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_EXPRGRAPHNODE}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicNonlinear2(scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicNonlinear2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_EXPRGRAPHNODE}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, exprgraphnode, lhs, rhs)
...
_SCIPcreateConsOrbitope(scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsOrbitope", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{Ptr{Ptr{_SCIP_VAR}}}, _SCIP_Bool, Int, Int, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicOrbitope(scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop) = @scip_ccall_check("SCIPcreateConsBasicOrbitope", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{Ptr{Ptr{_SCIP_VAR}}}, _SCIP_Bool, Int, Int, _SCIP_Bool,), scip, cons, name, vars, ispart, nspcons, nblocks, resolveprop)
...
_SCIPcreateConsPseudobooleanWithConss(scip, cons, name, lincons, linconstype, andconss, andcoefs, nandconss, indvar, weight, issoftcons, intvar, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsPseudobooleanWithConss", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_CONS}, _SCIP_LINEARCONSTYPE, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Bool, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, lincons, linconstype, andconss, andcoefs, nandconss, indvar, weight, issoftcons, intvar, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
...
_SCIPcreateConsQuadratic(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoeffs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsQuadratic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoeffs, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicQuadratic(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicQuadratic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs)
_SCIPcreateConsQuadratic2(scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsQuadratic2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_QUADVARTERM}, Int, Ptr{_SCIP_BILINTERM}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicQuadratic2(scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicQuadratic2", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{_SCIP_QUADVARTERM}, Int, Ptr{_SCIP_BILINTERM}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nlinvars, linvars, lincoefs, nquadvarterms, quadvarterms, nbilinterms, bilinterms, lhs, rhs)
...
_SCIPchgLhsQuadratic(scip, cons, lhs) = @scip_ccall_check("SCIPchgLhsQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, _SCIP_Real,), scip, cons, lhs)
_SCIPchgRhsQuadratic(scip, cons, rhs) = @scip_ccall_check("SCIPchgRhsQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, _SCIP_Real,), scip, cons, rhs)
_SCIPgetFeasibilityQuadratic(scip, cons, sol, feasibility) = @scip_ccall_check("SCIPgetFeasibilityQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_SOL}, Ptr{_SCIP_Real},), scip, cons, sol, feasibility)
_SCIPgetActivityQuadratic(scip, cons, sol, activity) = @scip_ccall_check("SCIPgetActivityQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_SOL}, Ptr{_SCIP_Real},), scip, cons, sol, activity)
_SCIPchgLinearCoefQuadratic(scip, cons, var, coef) = @scip_ccall_check("SCIPchgLinearCoefQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, cons, var, coef)
_SCIPchgSquareCoefQuadratic(scip, cons, var, coef) = @scip_ccall_check("SCIPchgSquareCoefQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, cons, var, coef)
_SCIPchgBilinCoefQuadratic(scip, cons, var1, var2, coef) = @scip_ccall_check("SCIPchgBilinCoefQuadratic", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, cons, var1, var2, coef)
...
_SCIPcreateConsSOC(scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable) = @scip_ccall_check("SCIPcreateConsSOC", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, _SCIP_Real, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable)
_SCIPcreateConsBasicSOC(scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset) = @scip_ccall_check("SCIPcreateConsBasicSOC", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, _SCIP_Real, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real,), scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset)
...
_SCIPcreateConsSOS1(scip, cons, name, nvars, vars, weights, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsSOS1", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, nvars, vars, weights, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicSOS1(scip, cons, name, nvars, vars, weights) = @scip_ccall_check("SCIPcreateConsBasicSOS1", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real},), scip, cons, name, nvars, vars, weights)
...
_SCIPappendVarSOS1(scip, cons, var) = @scip_ccall_check("SCIPappendVarSOS1", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{_SCIP_VAR},), scip, cons, var)
_SCIPmakeSOS1sFeasible(scip, conshdlr, sol, changed, success) = @scip_ccall_check("SCIPmakeSOS1sFeasible", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_SOL}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, conshdlr, sol, changed, success)
...
_SCIPcreateConsSuperindicator(scip, cons, name, binvar, slackcons, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsSuperindicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, binvar, slackcons, initial, separate, enforce, check, propagate, localVar, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicSuperindicator(scip, cons, name, binvar, slackcons) = @scip_ccall_check("SCIPcreateConsBasicSuperindicator", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_CONS},), scip, cons, name, binvar, slackcons)
...
_SCIPcreateConsVarbound(scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsVarbound", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicVarbound(scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs) = @scip_ccall_check("SCIPcreateConsBasicVarbound", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_VAR}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, cons, name, var, vbdvar, vbdcoef, lhs, rhs)
...
_SCIPcreateConsXor(scip, cons, name, rhs, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateConsXor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, _SCIP_Bool, Int, Ptr{Ptr{_SCIP_VAR}}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, rhs, nvars, vars, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPcreateConsBasicXor(scip, cons, name, rhs, nvars, vars) = @scip_ccall_check("SCIPcreateConsBasicXor", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, _SCIP_Bool, Int, Ptr{Ptr{_SCIP_VAR}},), scip, cons, name, rhs, nvars, vars)
_SCIPdialoghdlrGetWord(dialoghdlr, dialog, prompt, inputword, endoffile) = @scip_ccall_check("SCIPdialoghdlrGetWord", 
    (Ptr{_SCIP_DIALOGHDLR}, Ptr{_SCIP_DIALOG}, String, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), dialoghdlr, dialog, prompt, inputword, endoffile)
_SCIPdialoghdlrAddInputLine(dialoghdlr, inputline) = @scip_ccall_check("SCIPdialoghdlrAddInputLine", 
    (Ptr{_SCIP_DIALOGHDLR}, String,), dialoghdlr, inputline)
_SCIPdialoghdlrAddHistory(dialoghdlr, dialog, command, escapecommand) = @scip_ccall_check("SCIPdialoghdlrAddHistory", 
    (Ptr{_SCIP_DIALOGHDLR}, Ptr{_SCIP_DIALOG}, String, _SCIP_Bool,), dialoghdlr, dialog, command, escapecommand)
...
_SCIPdialogDisplayCompletions(dialog, scip, entryname) = @scip_ccall_check("SCIPdialogDisplayCompletions", 
    (Ptr{_SCIP_DIALOG}, Ptr{_SCIP}, String,), dialog, scip, entryname)
_SCIPperformGenericDivingAlgorithm(scip, diveset, worksol, heur, result, nodeinfeasible) = @scip_ccall_check("SCIPperformGenericDivingAlgorithm", 
    (Ptr{_SCIP}, Ptr{_SCIP_DIVESET}, Ptr{_SCIP_SOL}, Ptr{_SCIP_HEUR}, Ptr{_SCIP_RESULT}, _SCIP_Bool,), scip, diveset, worksol, heur, result, nodeinfeasible)
...
_SCIPexprEvalShallow(expr, argvals, varvals, param, val) = @scip_ccall_check("SCIPexprEvalShallow", 
    (Ptr{_SCIP_EXPR}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real},), expr, argvals, varvals, param, val)
...
_SCIPexprEvalIntShallow(expr, infinity, argvals, varvals, param, val) = @scip_ccall_check("SCIPexprEvalIntShallow", 
    (Ptr{_SCIP_EXPR}, _SCIP_Real, Ptr{_SCIP_INTERVAL}, Ptr{_SCIP_INTERVAL}, Ptr{_SCIP_Real}, Ptr{_SCIP_INTERVAL},), expr, infinity, argvals, varvals, param, val)
...
_SCIPexprEvalUser(expr, argvals, val, gradient, hessian) = @scip_ccall_check("SCIPexprEvalUser", 
    (Ptr{_SCIP_EXPR}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real},), expr, argvals, val, gradient, hessian)
_SCIPexprEvalIntUser(expr, infinity, argvals, val, gradient, hessian) = @scip_ccall_check("SCIPexprEvalIntUser", 
    (Ptr{_SCIP_EXPR}, _SCIP_Real, Ptr{_SCIP_INTERVAL}, Ptr{_SCIP_INTERVAL}, Ptr{_SCIP_INTERVAL}, Ptr{_SCIP_INTERVAL},), expr, infinity, argvals, val, gradient, hessian)
...
_SCIPexprEstimateUser(expr, infinity, argvals, argbounds, overestimate, coeffs, constant, success) = @scip_ccall_check("SCIPexprEstimateUser", 
    (Ptr{_SCIP_EXPR}, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_INTERVAL}, _SCIP_Bool, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), expr, infinity, argvals, argbounds, overestimate, coeffs, constant, success)
...
_SCIPexprParse(blkmem, messagehdlr, expr, str, lastchar, nvars, varnames) = @scip_ccall_check("SCIPexprParse", 
    (Ptr{BMS_BLKMEM}, Ptr{_SCIP_MESSAGEHDLR}, Ptr{Ptr{_SCIP_EXPR}}, String, String, Ptr{Int}, Ptr{Int},), blkmem, messagehdlr, expr, str, lastchar, nvars, varnames)
...
_SCIPexprgraphGetNodePolynomialMonomialCurvature(node, monomialidx, infinity, curv) = @scip_ccall_check("SCIPexprgraphGetNodePolynomialMonomialCurvature", 
    (Ptr{_SCIP_EXPRGRAPHNODE}, Int, _SCIP_Real, Ptr{_SCIP_EXPRCURV},), node, monomialidx, infinity, curv)
...
_SCIPexprgraphPrintDot(exprgraph, messagehdlr, file, varnames) = @scip_ccall_check("SCIPexprgraphPrintDot", 
    (Ptr{_SCIP_EXPRGRAPH}, Ptr{_SCIP_MESSAGEHDLR}, Ptr{FILE}, Ptr{Ptr{Char}},), exprgraph, messagehdlr, file, varnames)
...
_SCIPexprgraphGetSumTrees(exprgraph, node, exprtreessize, nexprtrees, exprtrees, exprtreecoefs) = @scip_ccall_check("SCIPexprgraphGetSumTrees", 
    (Ptr{_SCIP_EXPRGRAPH}, Ptr{_SCIP_EXPRGRAPHNODE}, Int, Ptr{Int}, Ptr{Ptr{_SCIP_EXPRTREE}}, Ptr{_SCIP_Real},), exprgraph, node, exprtreessize, nexprtrees, exprtrees, exprtreecoefs)
_SCIPmatrixCreate(scip, matrixptr, initialized, complete) = @scip_ccall_check("SCIPmatrixCreate", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIPMILPMATRIX}}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, matrixptr, initialized, complete)
_SCIPmatrixGetParallelRows(scip, matrix, scale, pclass) = @scip_ccall_check("SCIPmatrixGetParallelRows", 
    (Ptr{_SCIP}, Ptr{_SCIPMILPMATRIX}, Ptr{_SCIP_Real}, Ptr{Int},), scip, matrix, scale, pclass)
_SCIPmatrixGetParallelCols(scip, matrix, scale, pclass, varineq) = @scip_ccall_check("SCIPmatrixGetParallelCols", 
    (Ptr{_SCIP}, Ptr{_SCIPMILPMATRIX}, Ptr{_SCIP_Real}, Ptr{Int}, Ptr{_SCIP_Bool},), scip, matrix, scale, pclass, varineq)
...
_SCIPdigraphAddArcSafe(digraph, startnode, endnode, data) = @scip_ccall_check("SCIPdigraphAddArcSafe", 
    (Ptr{_SCIP_DIGRAPH}, Int, Int, Ptr{Void},), digraph, startnode, endnode, data)
_SCIPdigraphSetNSuccessors(digraph, node, nsuccessors) = @scip_ccall_check("SCIPdigraphSetNSuccessors", 
    (Ptr{_SCIP_DIGRAPH}, Int, Int,), digraph, node, nsuccessors)
...
_SCIPdigraphComputeDirectedComponents(digraph, compidx, strongcomponents, strongcompstartidx, nstrongcomponents) = @scip_ccall_check("SCIPdigraphComputeDirectedComponents", 
    (Ptr{_SCIP_DIGRAPH}, Int, Ptr{Int}, Ptr{Int}, Ptr{Int},), digraph, compidx, strongcomponents, strongcompstartidx, nstrongcomponents)
...
_SCIPcomputeArraysIntersection(array1, narray1, array2, narray2, intersectarray, nintersectarray) = @scip_ccall_check("SCIPcomputeArraysIntersection", 
    (Ptr{Int}, Int, Ptr{Int}, Int, Ptr{Int}, Ptr{Int},), array1, narray1, array2, narray2, intersectarray, nintersectarray)
_SCIPcomputeArraysSetminus(array1, narray1, array2, narray2, setminusarray, nsetminusarray) = @scip_ccall_check("SCIPcomputeArraysSetminus", 
    (Ptr{Int}, Int, Ptr{Int}, Int, Ptr{Int}, Ptr{Int},), array1, narray1, array2, narray2, setminusarray, nsetminusarray)
...
_SCIPcopyProb(sourcescip, targetscip, varmap, consmap, globalVar, name) = @scip_ccall_check("SCIPcopyProb", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, _SCIP_Bool, String,), sourcescip, targetscip, varmap, consmap, globalVar, name)
_SCIPcopyOrigProb(sourcescip, targetscip, varmap, consmap, name) = @scip_ccall_check("SCIPcopyOrigProb", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, String,), sourcescip, targetscip, varmap, consmap, name)
...
_SCIPmergeVariableStatistics(sourcescip, targetscip, sourcevars, targetvars, nvars) = @scip_ccall_check("SCIPmergeVariableStatistics", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{_SCIP_VAR}}, Int,), sourcescip, targetscip, sourcevars, targetvars, nvars)
_SCIPgetConsCopy(sourcescip, targetscip, sourcecons, targetcons, sourceconshdlr, varmap, consmap, name, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, success) = @scip_ccall_check("SCIPgetConsCopy", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_CONS}, Ptr{Ptr{_SCIP_CONS}}, Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, String, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), sourcescip, targetscip, sourcecons, targetcons, sourceconshdlr, varmap, consmap, name, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, globalVar, success)
...
_SCIPcopy(sourcescip, targetscip, varmap, consmap, suffix, globalVar, enablepricing, passmessagehdlr, valid) = @scip_ccall_check("SCIPcopy", 
    (Ptr{_SCIP}, Ptr{_SCIP}, Ptr{_SCIP_HASHMAP}, Ptr{_SCIP_HASHMAP}, String, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), sourcescip, targetscip, varmap, consmap, suffix, globalVar, enablepricing, passmessagehdlr, valid)
...
_SCIPsetBoolParam(scip, name, value) = @scip_ccall_check("SCIPsetBoolParam", 
    (Ptr{_SCIP}, String, _SCIP_Bool,), scip, name, value)
_SCIPcheckBoolParam(scip, param, value) = @scip_ccall_check("SCIPcheckBoolParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, _SCIP_Bool,), scip, param, value)
...
_SCIPsetIntParam(scip, name, value) = @scip_ccall_check("SCIPsetIntParam", 
    (Ptr{_SCIP}, String, Int,), scip, name, value)
...
_SCIPsetLongintParam(scip, name, value) = @scip_ccall_check("SCIPsetLongintParam", 
    (Ptr{_SCIP}, String, Int64,), scip, name, value)
_SCIPcheckLongintParam(scip, param, value) = @scip_ccall_check("SCIPcheckLongintParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, Int64,), scip, param, value)
...
_SCIPsetRealParam(scip, name, value) = @scip_ccall_check("SCIPsetRealParam", 
    (Ptr{_SCIP}, String, _SCIP_Real,), scip, name, value)
...
_SCIPsetCharParam(scip, name, value) = @scip_ccall_check("SCIPsetCharParam", 
    (Ptr{_SCIP}, String, Char,), scip, name, value)
_SCIPcheckCharParam(scip, param, value) = @scip_ccall_check("SCIPcheckCharParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, Char,), scip, param, value)
_SCIPchgStringParam(scip, param, value) = @scip_ccall_check("SCIPchgStringParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, String,), scip, param, value)
_SCIPsetStringParam(scip, name, value) = @scip_ccall_check("SCIPsetStringParam", 
    (Ptr{_SCIP}, String, String,), scip, name, value)
_SCIPcheckStringParam(scip, param, value) = @scip_ccall_check("SCIPcheckStringParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, String,), scip, param, value)
_SCIPreadParams(scip, filename) = @scip_ccall_check("SCIPreadParams", 
    (Ptr{_SCIP}, String,), scip, filename)
_SCIPwriteParam(scip, param, filename, comments, onlychanged) = @scip_ccall_check("SCIPwriteParam", 
    (Ptr{_SCIP}, Ptr{_SCIP_PARAM}, String, _SCIP_Bool, _SCIP_Bool,), scip, param, filename, comments, onlychanged)
_SCIPwriteParams(scip, filename, comments, onlychanged) = @scip_ccall_check("SCIPwriteParams", 
    (Ptr{_SCIP}, String, _SCIP_Bool, _SCIP_Bool,), scip, filename, comments, onlychanged)
...
_SCIPincludeReaderBasic(scip, readerptr, name, desc, extension, readerdata) = @scip_ccall_check("SCIPincludeReaderBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_READER}}, String, String, String, Ptr{_SCIP_READERDATA},), scip, readerptr, name, desc, extension, readerdata)
...
_SCIPsetComprPriority(scip, compr, priority) = @scip_ccall_check("SCIPsetComprPriority", 
    (Ptr{_SCIP}, Ptr{_SCIP_COMPR}, Int,), scip, compr, priority)
...
_SCIPincludeBranchruleBasic(scip, branchruleptr, name, desc, priority, maxdepth, maxbounddist, branchruledata) = @scip_ccall_check("SCIPincludeBranchruleBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_BRANCHRULE}}, String, String, Int, Int, _SCIP_Real, Ptr{_SCIP_BRANCHRULEDATA},), scip, branchruleptr, name, desc, priority, maxdepth, maxbounddist, branchruledata)
...
_SCIPincludeExternalCodeInformation(scip, name, description) = @scip_ccall_check("SCIPincludeExternalCodeInformation", 
    (Ptr{_SCIP}, String, String,), scip, name, description)
...
_SCIPaddDialogInputLine(scip, inputline) = @scip_ccall_check("SCIPaddDialogInputLine", 
    (Ptr{_SCIP}, String,), scip, inputline)
...
_SCIPreadProb(scip, filename, extension) = @scip_ccall_check("SCIPreadProb", 
    (Ptr{_SCIP}, String, String,), scip, filename, extension)
_SCIPwriteOrigProblem(scip, filename, extension, genericnames) = @scip_ccall_check("SCIPwriteOrigProblem", 
    (Ptr{_SCIP}, String, String, _SCIP_Bool,), scip, filename, extension, genericnames)
...
_SCIPrestartSolve(scip) = @scip_ccall_check("SCIPrestartSolve", 
    (Ptr{_SCIP},), scip)
_SCIPenableReoptimization(scip, enable) = @scip_ccall_check("SCIPenableReoptimization", 
    (Ptr{_SCIP}, _SCIP_Bool,), scip, enable)
_SCIPgetReopSolsRun(scip, run, sols, allocmem, nsols) = @scip_ccall_check("SCIPgetReopSolsRun", 
    (Ptr{_SCIP}, Int, Ptr{Ptr{_SCIP_SOL}}, Int, Ptr{Int},), scip, run, sols, allocmem, nsols)
_SCIPcheckReoptRestart(scip, node, restart) = @scip_ccall_check("SCIPcheckReoptRestart", 
    (Ptr{_SCIP}, Ptr{_SCIP_NODE}, Ptr{_SCIP_Bool},), scip, node, restart)
_SCIPaddReoptDualBndchg(scip, node, var, newbound, oldbound) = @scip_ccall_check("SCIPaddReoptDualBndchg", 
    (Ptr{_SCIP}, Ptr{_SCIP_NODE}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real,), scip, node, var, newbound, oldbound)
_SCIPgetReoptOldObjCoef(scip, var, run, objcoef) = @scip_ccall_check("SCIPgetReoptOldObjCoef", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, Int, Ptr{_SCIP_Real},), scip, var, run, objcoef)
_SCIPcreateVarBasic(scip, var, name, lb, ub, obj, vartype) = @scip_ccall_check("SCIPcreateVarBasic", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_VAR}}, String, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_VARTYPE,), scip, var, name, lb, ub, obj, vartype)
...
_SCIPparseVarName(scip, str, var, endptr) = @scip_ccall_check("SCIPparseVarName", 
    (Ptr{_SCIP}, String, Ptr{Ptr{_SCIP_VAR}}, Ptr{Ptr{Char}},), scip, str, var, endptr)
_SCIPparseVarsList(scip, str, vars, nvars, varssize, requiredsize, endptr, delimiter, success) = @scip_ccall_check("SCIPparseVarsList", 
    (Ptr{_SCIP}, String, Ptr{Ptr{_SCIP_VAR}}, Ptr{Int}, Int, Ptr{Int}, Ptr{Ptr{Char}}, Char, Ptr{_SCIP_Bool},), scip, str, vars, nvars, varssize, requiredsize, endptr, delimiter, success)
_SCIPparseVarsLinearsum(scip, str, vars, vals, nvars, varssize, requiredsize, endptr, success) = @scip_ccall_check("SCIPparseVarsLinearsum", 
    (Ptr{_SCIP}, String, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Ptr{Int}, Int, Ptr{Int}, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), scip, str, vars, vals, nvars, varssize, requiredsize, endptr, success)
_SCIPparseVarsPolynomial(scip, str, monomialvars, monomialexps, monomialcoefs, monomialnvars, nmonomials, endptr, success) = @scip_ccall_check("SCIPparseVarsPolynomial", 
    (Ptr{_SCIP}, String, Ptr{Ptr{Ptr{Ptr{_SCIP_VAR}}}}, Ptr{Ptr{Ptr{_SCIP_Real}}}, Ptr{Ptr{_SCIP_Real}}, Ptr{Ptr{Int}}, Ptr{Int}, Ptr{Ptr{Char}}, Ptr{_SCIP_Bool},), scip, str, monomialvars, monomialexps, monomialcoefs, monomialnvars, nmonomials, endptr, success)
...
_SCIPchgVarName(scip, var, name) = @scip_ccall_check("SCIPchgVarName", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, String,), scip, var, name)
...
_SCIPgetVarStrongbranchWithPropagation(scip, var, solval, lpobjval, itlim, maxproprounds, down, up, downvalid, upvalid, ndomredsdown, ndomredsup, downinf, upinf, downconflict, upconflict, lperror, newlbs, newubs) = @scip_ccall_check("SCIPgetVarStrongbranchWithPropagation", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, Int, Int, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Int64}, Ptr{Int64}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real},), scip, var, solval, lpobjval, itlim, maxproprounds, down, up, downvalid, upvalid, ndomredsdown, ndomredsup, downinf, upinf, downconflict, upconflict, lperror, newlbs, newubs)
...
_SCIPtightenVarUb(scip, var, newbound, force, infeasible, tightened) = @scip_ccall_check("SCIPtightenVarUb", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Bool, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, var, newbound, force, infeasible, tightened)
_SCIPinferVarFixCons(scip, var, fixedval, infercons, inferinfo, force, infeasible, tightened) = @scip_ccall_check("SCIPinferVarFixCons", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, Ptr{_SCIP_CONS}, Int, _SCIP_Bool, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, var, fixedval, infercons, inferinfo, force, infeasible, tightened)
...
_SCIPinferVarFixProp(scip, var, fixedval, inferprop, inferinfo, force, infeasible, tightened) = @scip_ccall_check("SCIPinferVarFixProp", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, Ptr{_SCIP_PROP}, Int, _SCIP_Bool, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, var, fixedval, inferprop, inferinfo, force, infeasible, tightened)
...
_SCIPaddClique(scip, vars, values, nvars, isequation, infeasible, nbdchgs) = @scip_ccall_check("SCIPaddClique", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Bool}, Int, _SCIP_Bool, Ptr{_SCIP_Bool}, Ptr{Int},), scip, vars, values, nvars, isequation, infeasible, nbdchgs)
...
_SCIPcalcNegatedCliquePartition(scip, vars, nvars, cliquepartition, ncliques) = @scip_ccall_check("SCIPcalcNegatedCliquePartition", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_VAR}}, Int, Ptr{Int}, Ptr{Int},), scip, vars, nvars, cliquepartition, ncliques)
_SCIPcleanupCliques(scip, infeasible) = @scip_ccall_check("SCIPcleanupCliques", 
    (Ptr{_SCIP}, Ptr{_SCIP_Bool},), scip, infeasible)
_SCIPwriteCliqueGraph(scip, fname, writenodeweights) = @scip_ccall_check("SCIPwriteCliqueGraph", 
    (Ptr{_SCIP}, String, _SCIP_Bool,), scip, fname, writenodeweights)
_SCIPremoveVarFromGlobalStructures(scip, var) = @scip_ccall_check("SCIPremoveVarFromGlobalStructures", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR},), scip, var)
...
_SCIPinitVarValueBranchStats(scip, var, value, downvsids, upvsids, downconflen, upconflen, downinfer, upinfer, downcutoff, upcutoff) = @scip_ccall_check("SCIPinitVarValueBranchStats", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real, _SCIP_Real,), scip, var, value, downvsids, upvsids, downconflen, upconflen, downinfer, upinfer, downcutoff, upcutoff)
...
_SCIPcreateCons(scip, cons, name, conshdlr, consdata, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode) = @scip_ccall_check("SCIPcreateCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, Ptr{_SCIP_CONSHDLR}, Ptr{_SCIP_CONSDATA}, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, cons, name, conshdlr, consdata, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode)
_SCIPparseCons(scip, cons, str, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, success) = @scip_ccall_check("SCIPparseCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_CONS}}, String, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{_SCIP_Bool},), scip, cons, str, initial, separate, enforce, check, propagate, localVar, modifiable, dynamic, removable, stickingatnode, success)
...
_SCIPchgConsName(scip, cons, name) = @scip_ccall_check("SCIPchgConsName", 
    (Ptr{_SCIP}, Ptr{_SCIP_CONS}, String,), scip, cons, name)
...
_SCIPgetLPBInvRow(scip, r, coefs, inds, ninds) = @scip_ccall_check("SCIPgetLPBInvRow", 
    (Ptr{_SCIP}, Int, Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int},), scip, r, coefs, inds, ninds)
_SCIPgetLPBInvCol(scip, c, coefs, inds, ninds) = @scip_ccall_check("SCIPgetLPBInvCol", 
    (Ptr{_SCIP}, Int, Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int},), scip, c, coefs, inds, ninds)
_SCIPgetLPBInvARow(scip, r, binvrow, coefs, inds, ninds) = @scip_ccall_check("SCIPgetLPBInvARow", 
    (Ptr{_SCIP}, Int, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int},), scip, r, binvrow, coefs, inds, ninds)
_SCIPgetLPBInvACol(scip, c, coefs, inds, ninds) = @scip_ccall_check("SCIPgetLPBInvACol", 
    (Ptr{_SCIP}, Int, Ptr{_SCIP_Real}, Ptr{Int}, Ptr{Int},), scip, c, coefs, inds, ninds)
...
_SCIPcalcMIR(scip, sol, boundswitch, usevbds, allowlocal, fixintegralrhs, boundsfortrans, boundtypesfortrans, maxmksetcoefs, maxweightrange, minfrac, maxfrac, weights, maxweight, weightinds, nweightinds, rowlensum, sidetypes, scale, mksetcoefs, mksetcoefsvalid, mircoef, mirrhs, cutactivity, success, cutislocal, cutrank) = @scip_ccall_check("SCIPcalcMIR", 
    (Ptr{_SCIP}, Ptr{_SCIP_SOL}, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool, Ptr{Int}, Ptr{_SCIP_BOUNDTYPE}, Int, _SCIP_Real, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Real}, _SCIP_Real, Ptr{Int}, Int, Int, Ptr{Int}, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Int},), scip, sol, boundswitch, usevbds, allowlocal, fixintegralrhs, boundsfortrans, boundtypesfortrans, maxmksetcoefs, maxweightrange, minfrac, maxfrac, weights, maxweight, weightinds, nweightinds, rowlensum, sidetypes, scale, mksetcoefs, mksetcoefsvalid, mircoef, mirrhs, cutactivity, success, cutislocal, cutrank)
_SCIPcalcStrongCG(scip, boundswitch, usevbds, allowlocal, maxmksetcoefs, maxweightrange, minfrac, maxfrac, weights, inds, ninds, scale, mircoef, mirrhs, cutactivity, success, cutislocal, cutrank) = @scip_ccall_check("SCIPcalcStrongCG", 
    (Ptr{_SCIP}, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, Int, _SCIP_Real, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{Int}, Int, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool}, Ptr{Int},), scip, boundswitch, usevbds, allowlocal, maxmksetcoefs, maxweightrange, minfrac, maxfrac, weights, inds, ninds, scale, mircoef, mirrhs, cutactivity, success, cutislocal, cutrank)
...
_SCIPwriteMIP(scip, filename, genericnames, origobj, lazyconss) = @scip_ccall_check("SCIPwriteMIP", 
    (Ptr{_SCIP}, String, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, filename, genericnames, origobj, lazyconss)
...
_SCIPcreateRowCons(scip, row, conshdlr, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_CONSHDLR}, String, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, conshdlr, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateRowSepa(scip, row, sepa, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowSepa", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_SEPA}, String, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, sepa, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateRowUnspec(scip, row, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateRowUnspec", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, String, Int, Ptr{Ptr{_SCIP_COL}}, Ptr{_SCIP_Real}, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, name, len, cols, vals, lhs, rhs, localVar, modifiable, removable)
...
_SCIPcreateEmptyRowCons(scip, row, conshdlr, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowCons", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_CONSHDLR}, String, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, conshdlr, name, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateEmptyRowSepa(scip, row, sepa, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowSepa", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, Ptr{_SCIP_SEPA}, String, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, sepa, name, lhs, rhs, localVar, modifiable, removable)
_SCIPcreateEmptyRowUnspec(scip, row, name, lhs, rhs, localVar, modifiable, removable) = @scip_ccall_check("SCIPcreateEmptyRowUnspec", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_ROW}}, String, _SCIP_Real, _SCIP_Real, _SCIP_Bool, _SCIP_Bool, _SCIP_Bool,), scip, row, name, lhs, rhs, localVar, modifiable, removable)
...
_SCIPsetNLPStringPar(scip, typeVar, sval) = @scip_ccall_check("SCIPsetNLPStringPar", 
    (Ptr{_SCIP}, _SCIP_NLPPARAM, String,), scip, typeVar, sval)
...
_SCIPcreateNlRow(scip, nlrow, name, constant, nlinvars, linvars, lincoefs, nquadvars, quadvars, nquadelems, quadelems, expression, lhs, rhs) = @scip_ccall_check("SCIPcreateNlRow", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_NLROW}}, String, _SCIP_Real, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, Ptr{Ptr{_SCIP_VAR}}, Int, Ptr{_SCIP_QUADELEM}, Ptr{_SCIP_EXPRTREE}, _SCIP_Real, _SCIP_Real,), scip, nlrow, name, constant, nlinvars, linvars, lincoefs, nquadvars, quadvars, nquadelems, quadelems, expression, lhs, rhs)
_SCIPcreateEmptyNlRow(scip, nlrow, name, lhs, rhs) = @scip_ccall_check("SCIPcreateEmptyNlRow", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_NLROW}}, String, _SCIP_Real, _SCIP_Real,), scip, nlrow, name, lhs, rhs)
...
_SCIPchgVarObjProbing(scip, var, newobj) = @scip_ccall_check("SCIPchgVarObjProbing", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_Real,), scip, var, newobj)
...
_SCIPaddRowProbing(scip, row) = @scip_ccall_check("SCIPaddRowProbing", 
    (Ptr{_SCIP}, Ptr{_SCIP_ROW},), scip, row)
_SCIPapplyCutsProbing(scip, cutoff) = @scip_ccall_check("SCIPapplyCutsProbing", 
    (Ptr{_SCIP}, Ptr{_SCIP_Bool},), scip, cutoff)
_SCIPgetDivesetScore(scip, diveset, divetype, divecand, divecandsol, divecandfrac, candscore, roundup) = @scip_ccall_check("SCIPgetDivesetScore", 
    (Ptr{_SCIP}, Ptr{_SCIP_DIVESET}, _SCIP_DIVETYPE, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_Real, Ptr{_SCIP_Real}, Ptr{_SCIP_Bool},), scip, diveset, divetype, divecand, divecandsol, divecandfrac, candscore, roundup)
_SCIPgetDiveBoundChanges(scip, diveset, sol, success, infeasible) = @scip_ccall_check("SCIPgetDiveBoundChanges", 
    (Ptr{_SCIP}, Ptr{_SCIP_DIVESET}, Ptr{_SCIP_SOL}, Ptr{_SCIP_Bool}, Ptr{_SCIP_Bool},), scip, diveset, sol, success, infeasible)
_SCIPaddDiveBoundChange(scip, var, dir, value, preferred) = @scip_ccall_check("SCIPaddDiveBoundChange", 
    (Ptr{_SCIP}, Ptr{_SCIP_VAR}, _SCIP_BRANCHDIR, _SCIP_Real, _SCIP_Bool,), scip, var, dir, value, preferred)
...
_SCIPcreateSolCopyOrig(scip, sol, sourcesol) = @scip_ccall_check("SCIPcreateSolCopyOrig", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_SOL}}, Ptr{_SCIP_SOL},), scip, sol, sourcesol)
...
_SCIPgetSolVals(scip, sol, nvars, vars, vals) = @scip_ccall_check("SCIPgetSolVals", 
    (Ptr{_SCIP}, Ptr{_SCIP_SOL}, Int, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real},), scip, sol, nvars, vars, vals)
_SCIPrecomputeSolObj(scip, sol) = @scip_ccall_check("SCIPrecomputeSolObj", 
    (Ptr{_SCIP}, Ptr{_SCIP_SOL},), scip, sol)
...
_SCIPgetReoptChildIDs(scip, node, ids, mem, nids) = @scip_ccall_check("SCIPgetReoptChildIDs", 
    (Ptr{_SCIP}, Ptr{_SCIP_NODE}, Ptr{Uint}, Int, Ptr{Int},), scip, node, ids, mem, nids)
_SCIPgetReoptLeaveIDs(scip, node, ids, mem, nids) = @scip_ccall_check("SCIPgetReoptLeaveIDs", 
    (Ptr{_SCIP}, Ptr{_SCIP_NODE}, Ptr{Uint}, Int, Ptr{Int},), scip, node, ids, mem, nids)
_SCIPaddReoptnodeBndchg(scip, reoptnode, var, val, boundtype) = @scip_ccall_check("SCIPaddReoptnodeBndchg", 
    (Ptr{_SCIP}, Ptr{_SCIP_REOPTNODE}, Ptr{_SCIP_VAR}, _SCIP_Real, _SCIP_BOUNDTYPE,), scip, reoptnode, var, val, boundtype)
_SCIPsetReoptCompression(scip, representation, nrepresentatives, success) = @scip_ccall_check("SCIPsetReoptCompression", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_REOPTNODE}}, Int, Ptr{_SCIP_Bool},), scip, representation, nrepresentatives, success)
_SCIPaddReoptnodeCons(scip, reoptnode, vars, vals, nvars, constype) = @scip_ccall_check("SCIPaddReoptnodeCons", 
    (Ptr{_SCIP}, Ptr{_SCIP_REOPTNODE}, Ptr{Ptr{_SCIP_VAR}}, Ptr{_SCIP_Real}, Int, REOPT_CONSTYPE,), scip, reoptnode, vars, vals, nvars, constype)
_SCIPinitRepresentation(scip, representatives, nrepresentatives) = @scip_ccall_check("SCIPinitRepresentation", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_REOPTNODE}}, Int,), scip, representatives, nrepresentatives)
_SCIPresetRepresentation(scip, representatives, nrepresentatives) = @scip_ccall_check("SCIPresetRepresentation", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_REOPTNODE}}, Int,), scip, representatives, nrepresentatives)
_SCIPfreeRepresentation(scip, representatives, nrepresentatives) = @scip_ccall_check("SCIPfreeRepresentation", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_REOPTNODE}}, Int,), scip, representatives, nrepresentatives)
_SCIPapplyReopt(scip, reoptnode, id, estimate, childnodes, ncreatedchilds, naddedconss, childnodessize, success) = @scip_ccall_check("SCIPapplyReopt", 
    (Ptr{_SCIP}, Ptr{_SCIP_REOPTNODE}, Uint, _SCIP_Real, Ptr{Ptr{_SCIP_NODE}}, Ptr{Int}, Ptr{Int}, Int, Ptr{_SCIP_Bool},), scip, reoptnode, id, estimate, childnodes, ncreatedchilds, naddedconss, childnodessize, success)
_SCIPresetReoptnodeDualcons(scip, node) = @scip_ccall_check("SCIPresetReoptnodeDualcons", 
    (Ptr{_SCIP}, Ptr{_SCIP_NODE},), scip, node)
_SCIPsplitReoptRoot(scip, ncreatedchilds, naddedconss) = @scip_ccall_check("SCIPsplitReoptRoot", 
    (Ptr{_SCIP}, Ptr{Int}, Ptr{Int},), scip, ncreatedchilds, naddedconss)
_SCIPdeleteReoptnode(scip, reoptnode) = @scip_ccall_check("SCIPdeleteReoptnode", 
    (Ptr{_SCIP}, Ptr{Ptr{_SCIP_REOPTNODE}},), scip, reoptnode)
...
_SCIPprintOrigProblem(scip, file, extension, genericnames) = @scip_ccall_check("SCIPprintOrigProblem", 
    (Ptr{_SCIP}, Ptr{FILE}, String, _SCIP_Bool,), scip, file, extension, genericnames)
...
_SCIPprintStatistics(scip, file) = @scip_ccall_check("SCIPprintStatistics", 
    (Ptr{_SCIP}, Ptr{FILE},), scip, file)
_SCIPprintReoptStatistics(scip, file) = @scip_ccall_check("SCIPprintReoptStatistics", 
    (Ptr{_SCIP}, Ptr{FILE},), scip, file)
