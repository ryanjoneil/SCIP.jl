...
import Base: pointer
export _SCIP_t, _SCIP_BDCHGIDX_t, _SCIP_BDCHGINFO_t, _SCIP_BILINTERM_t, _SCIP_Bool_t, _SCIP_BOOLARRAY_t, _SCIP_BOUNDCHG_t, _SCIP_BOUNDTYPE_t, _SCIP_BRANCHRULE_t, _SCIP_BRANCHRULEDATA_t, _SCIP_BT_t, _SCIP_BTNODE_t, _SCIP_CLIQUE_t, _SCIP_CLOCK_t, _SCIP_COL_t, _SCIP_CONFLICTHDLR_t, _SCIP_CONFLICTHDLRDATA_t, _SCIP_CONS_t, _SCIP_CONSDATA_t, _SCIP_CONSHDLR_t, _SCIP_CONSHDLRDATA_t, _SCIP_CUT_t, _SCIP_CUTPOOL_t, _SCIP_DIALOG_t, _SCIP_DIALOGDATA_t, _SCIP_DIALOGHDLR_t, _SCIP_DIGRAPH_t, _SCIP_DISP_t, _SCIP_DISPDATA_t, _SCIP_DOMCHG_t, _SCIP_EVENT_t, _SCIP_EVENTDATA_t, _SCIP_EVENTHDLR_t, _SCIP_EVENTHDLRDATA_t, _SCIP_EXPR_t, _SCIP_EXPRCURV_t, _SCIP_EXPRDATA_MONOMIAL_t, _SCIP_EXPRGRAPH_t, _SCIP_EXPRGRAPHNODE_t, _SCIP_EXPRINTDATA_t, _SCIP_EXPRTREE_t, _SCIP_HASHMAP_t, _SCIP_HASHMAPLIST_t, _SCIP_HASHTABLE_t, _SCIP_HEUR_t, _SCIP_HEURDATA_t, _SCIP_HISTORY_t, _SCIP_HOLELIST_t, _SCIP_INTARRAY_t, _SCIP_INTERVAL_t, _SCIP_LPI_t, _SCIP_MESSAGEHDLR_t, _SCIP_MESSAGEHDLRDATA_t, _SCIP_NLPI_t, _SCIP_NLPIPROBLEM_t, _SCIP_NLPSTATISTICS_t, _SCIP_NLROW_t, _SCIP_NODE_t, _SCIP_NODESEL_t, _SCIP_NODESELDATA_t, _SCIP_PARAM_t, _SCIP_PQUEUE_t, _SCIP_PRESOL_t, _SCIP_PRESOLDATA_t, _SCIP_PRICER_t, _SCIP_PRICERDATA_t, _SCIP_PROBDATA_t, _SCIP_PROFILE_t, _SCIP_PROP_t, _SCIP_PROPDATA_t, _SCIP_PTRARRAY_t, _SCIP_QUADELEM_t, _SCIP_QUADVARTERM_t, _SCIP_QUEUE_t, _SCIP_READER_t, _SCIP_READERDATA_t, _SCIP_Real_t, _SCIP_REALARRAY_t, _SCIP_RELAX_t, _SCIP_RELAXDATA_t, _SCIP_RESOURCEACTIVITY_t, _SCIP_RESULT_t, _SCIP_ROW_t, _SCIP_SEPA_t, _SCIP_SEPADATA_t, _SCIP_SOL_t, _SCIP_SPARSESOL_t, _SCIP_VALUEHISTORY_t, _SCIP_VAR_t, _SCIP_VARDATA_t
